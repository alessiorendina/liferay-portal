...
package com.liferay.commerce.address.admin.web.internal.frontend.data.set.provider;

import com.liferay.account.constants.AccountPortletKeys;
import com.liferay.account.model.AccountEntry;
import com.liferay.commerce.address.admin.web.internal.constants.CommerceAddressFDSNames;
import com.liferay.commerce.address.admin.web.internal.model.Address;
...
public class AddressCommerceChannelAccountEntryRelFDSActionProvider
	...
	private String _getCommerceChannelAccountEntryRelDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_address_admin/edit_account_entry_default_commerce_address"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
