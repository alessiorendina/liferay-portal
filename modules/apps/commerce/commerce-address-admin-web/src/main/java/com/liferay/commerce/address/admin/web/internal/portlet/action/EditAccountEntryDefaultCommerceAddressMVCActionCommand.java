...
package com.liferay.commerce.address.admin.web.internal.portlet.action;
...
@Component(
	property = {
		...
		"mvc.command.name=/commerce_address_admin/edit_account_entry_default_commerce_address"
	},
	service = MVCActionCommand.class
)
public class EditAccountEntryDefaultCommerceAddressMVCActionCommand
		...
		if (commerceChannelAccountEntryRelId > 0) {
			...
			_commerceChannelAccountEntryRelService.
				addCommerceChannelAccountEntryRel(
					accountEntryId, Address.class.getName(), classPK,
