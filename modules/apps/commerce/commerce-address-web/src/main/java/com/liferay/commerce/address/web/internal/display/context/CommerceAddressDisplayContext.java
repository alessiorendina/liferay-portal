...
import com.liferay.commerce.address.web.internal.portlet.configuration.CommerceAddressPortletInstanceConfiguration;
...
public class CommerceAddressDisplayContext {
	...
	public CommerceAddressDisplayContext(
		...
		_commerceAddressContentPortletInstanceConfiguration =
			ConfigurationProviderUtil.getPortletInstanceConfiguration(
				CommerceAddressPortletInstanceConfiguration.class,
	...
	public String getAddCommerceAddressURL() {
		return PortletURLBuilder.createRenderURL(
			...
			"/commerce_address/edit_commerce_address"
		).setRedirect(
			() -> {
	...
	private final CommerceAddressPortletInstanceConfiguration
		_commerceAddressContentPortletInstanceConfiguration;
