...
package com.liferay.commerce.address.web.internal.frontend;
...
@Component(
	...
	property = {
		"clay.data.provider.key=" + CommerceRegionsClayTable.NAME,
		"clay.data.set.display.name=" + CommerceRegionsClayTable.NAME
	},
	service = {
...
public class CommerceRegionsClayTable
	extends BaseTableClayDataSetDisplayView
	implements ClayDataSetActionProvider, ClayDataSetDataProvider<Region> {
	...
	public int getItemsCount(
		...
		return total = _regionService.getRegionsCount(countryId);
	}
