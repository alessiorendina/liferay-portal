...
@Component(
	property = {
		...
		"com.liferay.portlet.css-class-wrapper=portlet-commerce-address",
		...
		"javax.portlet.name=" + CommercePortletKeys.COMMERCE_ADDRESS,
...
public class CommerceAddressPortlet extends MVCPortlet {
