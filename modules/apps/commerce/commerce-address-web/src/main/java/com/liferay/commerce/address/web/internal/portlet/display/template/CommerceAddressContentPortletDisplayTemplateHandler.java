...
package com.liferay.commerce.address.web.internal.portlet.display.template;

import com.liferay.commerce.address.web.internal.display.context.CommerceAddressDisplayContext;
import com.liferay.commerce.address.web.internal.portlet.CommerceAddressPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CommercePortletKeys.COMMERCE_ADDRESS,
	service = TemplateHandler.class
)
public class CommerceAddressPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CommerceAddressPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CommercePortletKeys.COMMERCE_ADDRESS, resourceBundle));
	...
	public String getResourceName() {
		return CommercePortletKeys.COMMERCE_ADDRESS;
	}
