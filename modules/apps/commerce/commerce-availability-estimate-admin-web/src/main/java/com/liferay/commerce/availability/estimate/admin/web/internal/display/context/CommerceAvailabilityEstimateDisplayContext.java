...
package com.liferay.commerce.availability.estimate.admin.web.internal.display.context;

import com.liferay.commerce.availability.estimate.admin.web.internal.util.CommerceAvailabilityEstimateUtil;
...
public class CommerceAvailabilityEstimateDisplayContext {
	...
	public String getOrderByCol() {
		...
		_orderByCol = SearchOrderByUtil.getOrderByCol(
			_renderRequest,
			CommercePortletKeys.COMMERCE_AVAILABILITY_ESTIMATE_ADMIN,
			"priority");
	...
	public String getOrderByType() {
		...
		_orderByType = SearchOrderByUtil.getOrderByType(
			_renderRequest,
			CommercePortletKeys.COMMERCE_AVAILABILITY_ESTIMATE_ADMIN, "asc");
