...
>
	<c:if test="<%= commerceAvailabilityEstimateDisplayContext.hasManageCommerceAvailabilityEstimatesPermission() %>">
		<portlet:renderURL var="editURL">
			<portlet:param name="mvcRenderCommandName" value="/commerce_availability_estimate_admin/edit_commerce_availability_estimate" />
		...
		<portlet:actionURL name="/commerce_availability_estimate_admin/edit_commerce_availability_estimate" var="deleteURL">
