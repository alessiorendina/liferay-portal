...
<c:if test="<%= commerceAvailabilityEstimateDisplayContext.hasManageCommerceAvailabilityEstimatesPermission() %>">
	<clay:management-toolbar
		...
		propsTransformer="{CommerceAvailabilityEstimateManagementToolbarPropsTransformer} from commerce-availability-estimate-admin-web"
	/>

	<div class="container-fluid container-fluid-max-xl">
		<portlet:actionURL name="/commerce_availability_estimate_admin/edit_commerce_availability_estimate" var="editCommerceAvailabilityEstimateActionURL" />
					...
					<liferay-ui:search-container-column-text
						...
						href='<%=
							PortletURLBuilder.createRenderURL(
								...
								"/commerce_availability_estimate_admin/edit_commerce_availability_estimate"
							).setParameter(
