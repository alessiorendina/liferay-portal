...
import com.liferay.commerce.cart.web.internal.display.context.helper.CommerceCartRequestHelper;
...
public class CommerceCartDisplayContext {
	...
	public CommerceCartDisplayContext(
		...
		commerceContext = commerceCartRequestHelper.getCommerceContext();

		_commerceCartPortletInstanceConfiguration =
			configurationProvider.getPortletInstanceConfiguration(
				CommerceCartPortletInstanceConfiguration.class,
				commerceCartRequestHelper.getThemeDisplay());
	...
	public Map<Long, List<CommerceOrderValidatorResult>>
		...
		return _commerceOrderValidatorRegistry.getCommerceOrderValidatorResults(
			commerceCartRequestHelper.getLocale(), getCommerceOrder());
	}
	...
	public String getDeleteURL(CommerceOrderItem commerceOrderItem) {
		return PortletURLBuilder.createActionURL(
			...
			"/commerce_cart/edit_commerce_order_item"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			commerceCartRequestHelper.getCurrentURL()
		).setParameter(
	...
	public String getDisplayStyle() {
		return _commerceCartPortletInstanceConfiguration.displayStyle();
	}
	...
	public long getDisplayStyleGroupId() {
		...
		ThemeDisplay themeDisplay = commerceCartRequestHelper.getThemeDisplay();
	...
	public PortletURL getPortletURL() {
		...
		String delta = ParamUtil.getString(
			commerceCartRequestHelper.getRequest(), "delta");
		...
		String deltaEntry = ParamUtil.getString(
			commerceCartRequestHelper.getRequest(), "deltaEntry");
	...
	public boolean hasPermission(String actionId) throws PortalException {
		...
		return commerceOrderModelResourcePermission.contains(
			commerceCartRequestHelper.getPermissionChecker(), _commerceOrder,
			actionId);
	}
	...
	public boolean hasViewPricePermission() throws PortalException {
		...
		if ((accountEntry != null) && accountEntry.isBusinessAccount()) {
			return _commerceProductPortletResourcePermission.contains(
				commerceCartRequestHelper.getPermissionChecker(),
				accountEntry.getAccountEntryGroupId(), CPActionKeys.VIEW_PRICE);
		}

		return _commerceProductPortletResourcePermission.contains(
			commerceCartRequestHelper.getPermissionChecker(),
			commerceCartRequestHelper.getScopeGroupId(),
	...
	public boolean isValidCommerceOrder() throws PortalException {
		...
		return _commerceOrderValidatorRegistry.isValid(
			commerceCartRequestHelper.getLocale(), commerceOrder);
	}
	...
	private final CommerceCartPortletInstanceConfiguration
		_commerceCartPortletInstanceConfiguration;
