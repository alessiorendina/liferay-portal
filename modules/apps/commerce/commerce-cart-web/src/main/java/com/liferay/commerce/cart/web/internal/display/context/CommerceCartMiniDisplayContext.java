 ...
 */
public class CommerceCartMiniDisplayContext extends CommerceCartDisplayContext {

	public CommerceCartMiniDisplayContext(
		...
		_commerceCartMiniPortletInstanceConfiguration =
			configurationProvider.getPortletInstanceConfiguration(
				CommerceCartMiniPortletInstanceConfiguration.class,
	...
	public String getCommerceCartPortletURL() throws PortalException {
		return _commerceOrderHttpHelper.getCommerceCartPortletURL(
			commerceCartRequestHelper.getRequest());
	}
	...
	public String getDisplayStyle() {
		return _commerceCartMiniPortletInstanceConfiguration.displayStyle();
	}
	...
	private final CommerceCartMiniPortletInstanceConfiguration
		_commerceCartMiniPortletInstanceConfiguration;
