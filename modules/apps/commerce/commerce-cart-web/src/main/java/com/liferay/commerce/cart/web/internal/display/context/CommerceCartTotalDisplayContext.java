 ...
 */
public class CommerceCartTotalDisplayContext
	extends CommerceCartDisplayContext {

	public CommerceCartTotalDisplayContext(
		...
		_commerceCartTotalPortletInstanceConfiguration =
			configurationProvider.getPortletInstanceConfiguration(
				CommerceCartTotalPortletInstanceConfiguration.class,
	...
	public String getDisplayStyle() {
		return _commerceCartTotalPortletInstanceConfiguration.displayStyle();
	}
	...
	private final CommerceCartTotalPortletInstanceConfiguration
		_commerceCartTotalPortletInstanceConfiguration;
