...
@Component(
	property = {
		...
		"javax.portlet.name=" + CommercePortletKeys.COMMERCE_CART_MINI,
...
public class CommerceCartMiniPortlet extends MVCPortlet {
	...
	public void render(
		...
		try {
			CommerceCartMiniDisplayContext commerceCartDisplayContext =
				new CommerceCartMiniDisplayContext(
					...
					_percentageFormatter, _groupLocalService,
