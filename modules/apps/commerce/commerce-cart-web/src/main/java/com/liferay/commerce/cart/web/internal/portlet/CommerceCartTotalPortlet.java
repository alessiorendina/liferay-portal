...
@Component(
	property = {
		...
		"com.liferay.portlet.scopeable=false", "jakarta.portlet.version=4.0",
		"javax.portlet.display-name=Cart Summary",
		"javax.portlet.expiration-cache=0",
		"javax.portlet.init-param.view-template=/cart_total/view.jsp",
		"javax.portlet.name=" + CommercePortletKeys.COMMERCE_CART_TOTAL,
...
public class CommerceCartTotalPortlet extends MVCPortlet {
	...
	public void render(
		...
		try {
			CommerceCartTotalDisplayContext commerceCartTotalDisplayContext =
				new CommerceCartTotalDisplayContext(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceCartTotalPortlet.class);
