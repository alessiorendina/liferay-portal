...
public class CommerceCartConfigurationAction extends BaseConfigurationAction {
		...
		try {
			CommerceCartDisplayContext commerceCartDisplayContext =
				new CommerceCartDisplayContext(
					...
					_cpInstanceHelper, _groupLocalService, httpServletRequest,
					_portal);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceCartConfigurationAction.class);
