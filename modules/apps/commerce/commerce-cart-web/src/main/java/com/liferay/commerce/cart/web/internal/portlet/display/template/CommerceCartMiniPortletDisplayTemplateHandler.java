...
import com.liferay.commerce.cart.web.internal.display.context.CommerceCartMiniDisplayContext;
import com.liferay.commerce.cart.web.internal.portlet.CommerceCartMiniPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CommercePortletKeys.COMMERCE_CART_MINI,
	service = TemplateHandler.class
)
public class CommerceCartMiniPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CommerceCartMiniPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CommercePortletKeys.COMMERCE_CART_MINI, resourceBundle));
	...
	public String getResourceName() {
		return CommercePortletKeys.COMMERCE_CART_MINI;
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			...
			CommerceCartMiniDisplayContext.class,
			"commerceCartMiniDisplayContext");
