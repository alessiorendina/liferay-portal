...
import com.liferay.commerce.cart.web.internal.portlet.CommerceCartPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CommercePortletKeys.COMMERCE_CART,
	service = TemplateHandler.class
)
public class CommerceCartPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CommerceCartPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CommercePortletKeys.COMMERCE_CART, resourceBundle));
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"commerce-cart-display-context", CommerceCartDisplayContext.class,
			"commerceCartDisplayContext");
	...
	protected String getTemplatesConfigPath() {
		return "com/liferay/commerce/cart/web/internal/portlet/display" +
