...
page import="com.liferay.commerce.cart.web.internal.display.context.CommerceCartMiniDisplayContext" %><%@
page import="com.liferay.commerce.cart.web.internal.display.context.CommerceCartTotalDisplayContext" %><%@
page import="com.liferay.commerce.cart.web.internal.portlet.CommerceCartMiniPortlet" %><%@
page import="com.liferay.commerce.cart.web.internal.portlet.CommerceCartPortlet" %><%@
page import="com.liferay.commerce.cart.web.internal.portlet.CommerceCartTotalPortlet" %><%@
