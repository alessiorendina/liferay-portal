...
package com.liferay.commerce.catalog.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.catalog.admin.web.internal.constants.CommerceCatalogFDSNames;
import com.liferay.commerce.catalog.admin.web.internal.model.Catalog;
	...
	private PortletURL _getCatalogDeleteURL(
		...
		PortletURL portletURL = PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				httpServletRequest, CPPortletKeys.COMMERCE_CATALOGS_ADMIN,
				PortletRequest.ACTION_PHASE)
		).setActionName(
			"/commerce_catalogs_admin/edit_commerce_catalog"
		).setCMD(
			Constants.DELETE
		).buildPortletURL();
