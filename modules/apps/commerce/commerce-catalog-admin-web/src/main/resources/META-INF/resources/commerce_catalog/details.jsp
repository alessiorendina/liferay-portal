...
<portlet:actionURL name="/commerce_catalogs_admin/edit_commerce_catalog" var="editCommerceCatalogActionURL" />
				...
				<div class="col-12 lfr-form-content">
					...
					<c:if test="<%= commerceCatalogDisplayContext.showBasePriceListInputs() %>">
						...
						<liferay-frontend:component
							...
							%>'
							module="{detailsAutocompleteBasePrice} from commerce-catalog-admin-web"
						/>
						...
						<liferay-frontend:component
							...
							%>'
							module="{detailsAutocompleteBasePromotion} from commerce-catalog-admin-web"
						/>
					</c:if>
					...
					<c:choose>
						<c:when test="<%= commerceCatalogDisplayContext.hasManageLinkSupplierPermission(Constants.UPDATE) && !viewOnly %>">
							...
							<liferay-frontend:component
								...
								%>'
								module="{detailsAutocompleteAccountLink} from commerce-catalog-admin-web"
							/>
						</c:when>
						<c:otherwise>
				...
				<div class="row">
					<div class="col-12 h-100">
						...
						<div class="lfr-attachment-cover-image-selector">
							<portlet:actionURL name="/commerce_catalogs_admin/upload_commerce_media_default_image" var="uploadCommerceMediaDefaultImageActionURL" />
