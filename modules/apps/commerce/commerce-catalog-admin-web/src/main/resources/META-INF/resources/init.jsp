...
page import="com.liferay.commerce.catalog.admin.web.internal.constants.CommerceCatalogFDSNames" %><%@
page import="com.liferay.commerce.catalog.admin.web.internal.constants.CommerceCatalogScreenNavigationConstants" %><%@
page import="com.liferay.commerce.catalog.admin.web.internal.display.context.CommerceCatalogDisplayContext" %><%@
