...
package com.liferay.commerce.channel.admin.web.internal.display.context;

import com.liferay.account.constants.AccountConstants;
import com.liferay.account.model.AccountEntry;
import com.liferay.account.service.AccountEntryService;
import com.liferay.commerce.channel.admin.web.internal.display.context.helper.CommerceChannelRequestHelper;
...
public class CommerceChannelDisplayContext
	...
	public String getAddChannelURL() throws Exception {
		return PortletURLBuilder.create(
			...
			"/commerce_channels_admin/add_commerce_channel"
		).setRedirect(
			getPortletURL()
		).setWindowState(
	...
	public String getAddPaymentMethodURL(String commercePaymentMethodEngineKey)
		...
		return PortletURLBuilder.create(
			...
			"/commerce_payment_method_admin/edit_commerce_payment_method_group_rel"
		).setParameter(
