...
package com.liferay.commerce.channel.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.channel.admin.web.internal.constants.CommerceChannelFDSNames;
import com.liferay.commerce.channel.admin.web.internal.model.ChannelCurrency;
...
public class CommerceChannelCommerceCurrencyFDSActionProvider
	...
	private PortletURL _getCommerceChannelCommerceCurrencyDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_channels_admin/edit_commerce_channel_commerce_currency"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
