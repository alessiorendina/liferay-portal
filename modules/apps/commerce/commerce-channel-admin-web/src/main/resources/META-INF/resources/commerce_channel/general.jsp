...
<portlet:actionURL name="/commerce_channels_admin/edit_commerce_channel" var="editCommerceChannelActionURL" />
			...
			>
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<portlet:actionURL name="/commerce_channels_admin/upload_jrxml_template" var="uploadJRXMLTemplateURL" />
...
>
	<div>
		<c:if test='<%= FeatureFlagManagerUtil.isEnabled("LPD-35941") && commerceChannelDisplayContext.hasAddPaymentMethodsPermission() %>'>
			<div>
				<react:component
					module="{CommerceChannelAddPaymentMethod} from commerce-channel-admin-web"
					props='<%=
...
<liferay-frontend:component
	...
	%>'
	module="{CommerceChannelGeneral} from commerce-channel-admin-web"
/>