...
<liferay-portlet:renderURL var="editCommerceChannelExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_channels_admin/edit_commerce_channel_external_reference_code" />
...
<commerce-ui:header
	...
	thumbnailUrl='<%= PortalUtil.getPortalURL(request) + PortalUtil.getPathContext() + "/o/commerce-channel-admin-web/images/channel-default-icon.svg" %>'
