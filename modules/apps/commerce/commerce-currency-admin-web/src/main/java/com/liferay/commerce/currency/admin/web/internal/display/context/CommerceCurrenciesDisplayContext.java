...
package com.liferay.commerce.currency.admin.web.internal.display.context;

import com.liferay.commerce.currency.admin.web.internal.util.CommerceCurrencyUtil;
...
public class CommerceCurrenciesDisplayContext {
			...
			new FDSActionDropdownItem(
				PortletURLBuilder.create(
					PortalUtil.getControlPanelPortletURL(
						_httpServletRequest,
						CommerceCurrencyPortletKeys.COMMERCE_CURRENCY_ADMIN,
						PortletRequest.ACTION_PHASE)
				).setActionName(
					"/commerce_currency_admin/edit_commerce_currency"
				).setCMD(
					"updateExchangeRates"
				).buildString(),
	...
	public String getOrderByCol() {
		...
		_orderByCol = SearchOrderByUtil.getOrderByCol(
			_renderRequest, CommerceCurrencyPortletKeys.COMMERCE_CURRENCY_ADMIN,
			"priority");
