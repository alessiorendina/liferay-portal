...
package com.liferay.commerce.currency.admin.web.internal.frontend.data.set.provider;

import com.liferay.account.constants.AccountPortletKeys;
import com.liferay.account.model.AccountEntry;
import com.liferay.commerce.constants.CommerceAccountActionKeys;
import com.liferay.commerce.currency.admin.web.internal.constants.CommerceCurrencyFDSNames;
import com.liferay.commerce.currency.admin.web.internal.model.Currency;
...
public class CurrencyCommerceChannelAccountEntryRelFDSActionProvider
	...
	private String _getCommerceChannelAccountEntryRelDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_currency_admin/edit_account_entry_default_commerce_currency"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
