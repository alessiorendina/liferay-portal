...
package com.liferay.commerce.currency.admin.web.internal.portlet;
...
@Component(
	property = {
		...
		"javax.portlet.name=" + CommerceCurrencyPortletKeys.COMMERCE_CURRENCY_ADMIN,
...
public class CommerceCurrencyAdminPortlet extends MVCPortlet {
