...
public class EditAccountEntryDefaultCommerceCurrencyMVCActionCommand
		...
		if (commerceChannelAccountEntryRelId > 0) {
			...
			_commerceChannelAccountEntryRelService.
				addCommerceChannelAccountEntryRel(
					accountEntryId, CommerceCurrency.class.getName(), classPK,
					commerceChannelId, false, 0, type);
		}
	}
