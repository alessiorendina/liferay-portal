...
page import="com.liferay.commerce.currency.admin.web.internal.constants.CommerceCurrencyFDSNames" %><%@
page import="com.liferay.commerce.currency.admin.web.internal.constants.CommerceCurrencyScreenNavigationConstants" %><%@
page import="com.liferay.commerce.currency.admin.web.internal.display.context.CommerceChannelAccountEntryRelDisplayContext" %><%@
page import="com.liferay.commerce.currency.admin.web.internal.display.context.CommerceCurrenciesDisplayContext" %><%@
