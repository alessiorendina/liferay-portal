...
package com.liferay.commerce.inventory.admin.web.internal.display.context;
...
public class CommerceInventoryDisplayContext {
	...
	public String getCreateInventoryItemActionURL() throws Exception {
		return PortletURLBuilder.createRenderURL(
			...
			"/commerce_inventory_admin/add_commerce_inventory_item"
		).setWindowState(
			LiferayWindowState.POP_UP
		).buildString();
	}
	...
	public String getTransferQuantitiesActionURL() throws Exception {
		return PortletURLBuilder.createRenderURL(
			...
			"/commerce_inventory_admin/transfer_quantities"
		).setParameter(
			"sku", _sku
		).setParameter(
			"unitOfMeasureKey", _unitOfMeasureKey
