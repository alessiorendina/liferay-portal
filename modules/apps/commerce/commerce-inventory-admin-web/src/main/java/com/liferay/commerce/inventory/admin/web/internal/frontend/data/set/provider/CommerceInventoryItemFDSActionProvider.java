...
package com.liferay.commerce.inventory.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.inventory.admin.web.internal.constants.CommerceInventoryFDSNames;
import com.liferay.commerce.inventory.admin.web.internal.model.InventoryItem;
...
public class CommerceInventoryItemFDSActionProvider
	...
	private String _getCommerceInventoryItemEditURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_inventory_admin/edit_commerce_inventory_item"
		).setParameter(
			"sku", sku
		).setParameter(
	...
	private String _getInventoryItemDeleteURL(
		...
		return PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				...
				CPPortletKeys.COMMERCE_INVENTORY_ADMIN,
				PortletRequest.ACTION_PHASE)
		).setActionName(
			"/commerce_inventory_admin/edit_commerce_inventory_warehouse"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
