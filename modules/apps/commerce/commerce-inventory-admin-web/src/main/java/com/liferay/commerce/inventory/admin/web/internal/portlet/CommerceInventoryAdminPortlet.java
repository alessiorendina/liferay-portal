...
package com.liferay.commerce.inventory.admin.web.internal.portlet;

import com.liferay.commerce.inventory.admin.web.internal.display.context.CommerceInventoryDisplayContext;
...
@Component(
	property = {
		...
		"javax.portlet.name=" + CPPortletKeys.COMMERCE_INVENTORY_ADMIN,
...
public class CommerceInventoryAdminPortlet extends MVCPortlet {
