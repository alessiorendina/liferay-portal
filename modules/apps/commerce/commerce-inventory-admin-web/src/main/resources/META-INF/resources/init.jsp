...
<%@ page import="com.liferay.commerce.inventory.admin.web.internal.constants.CommerceInventoryFDSNames" %><%@
page import="com.liferay.commerce.inventory.admin.web.internal.constants.CommerceInventoryScreenNavigationConstants" %><%@
page import="com.liferay.commerce.inventory.admin.web.internal.display.context.CommerceInventoryDisplayContext" %><%@
