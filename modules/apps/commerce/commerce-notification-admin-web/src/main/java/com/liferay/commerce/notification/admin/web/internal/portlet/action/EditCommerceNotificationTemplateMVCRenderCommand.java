...
package com.liferay.commerce.notification.admin.web.internal.portlet.action;

import com.liferay.commerce.notification.admin.web.internal.display.context.CommerceNotificationTemplatesDisplayContext;
...
@Component(
	property = {
		...
		"mvc.command.name=/commerce_channels_admin/edit_commerce_notification_template"
	},
...
public class EditCommerceNotificationTemplateMVCRenderCommand
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.notification.admin.web)"
	)
