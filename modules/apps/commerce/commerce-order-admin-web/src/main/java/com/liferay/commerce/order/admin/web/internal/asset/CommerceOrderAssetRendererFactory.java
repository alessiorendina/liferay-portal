...
package com.liferay.commerce.order.admin.web.internal.asset;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CommercePortletKeys.COMMERCE_ORDER_ADMIN,
...
public class CommerceOrderAssetRendererFactory
	...
	public CommerceOrderAssetRendererFactory() {
		...
		setPortletId(CommercePortletKeys.COMMERCE_ORDER_ADMIN);
		setSelectable(false);
	}
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.order.admin.web)"
	)
