...
package com.liferay.commerce.order.admin.web.internal.display.context;
...
import com.liferay.commerce.order.admin.web.internal.display.context.helper.CommerceReturnRequestHelper;
			...
			dropdownItem -> {
				dropdownItem.setHref(
					PortletURLBuilder.create(
						...
						"/commerce_return_admin/edit_commerce_return_item_comment"
					).setParameter(
				...
				headerActionModels.add(
					new HeaderActionModel(
						...
						PortletURLBuilder.create(
							...
							"/commerce_payment_admin/edit_commerce_payment_entry"
						).setParameter(
			...
			headerActionModels.add(
				new HeaderActionModel(
					...
					PortletURLBuilder.createActionURL(
						...
						"/commerce_return_admin/edit_commerce_return"
					).buildString(),
					null, "reopen-return"));
		}
