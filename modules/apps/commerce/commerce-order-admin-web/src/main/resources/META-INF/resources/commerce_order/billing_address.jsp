...
<portlet:actionURL name="/commerce_order_admin/edit_commerce_order" var="editCommerceOrderBillingAddressActionURL" />
...
<div class="container-fluid container-fluid-max-xl p-4">
	<aui:form action="<%= editCommerceOrderBillingAddressActionURL %>" method="post" name="fm">
		...
		<frontend-data-set:classic-display
			...
			%>'
			creationMenu='<%= commerceOrderEditDisplayContext.getCommerceAddressCreationMenu("/commerce_order_admin/edit_commerce_order_billing_address") %>'
