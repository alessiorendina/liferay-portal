...
<portlet:actionURL name="/commerce_order_admin/edit_commerce_order" var="editCommerceOrderDeliveryTermsActionURL" />
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<liferay-frontend:component
				...
				%>'
				module="{termsDescriptionHandler} from commerce-order-admin-web"
			/>
		</c:otherwise>
	</c:choose>
</div>