...
<portlet:actionURL name="/commerce_order_admin/edit_commerce_order_note" var="editCommerceOrderNoteURL">
	<portlet:param name="mvcRenderCommandName" value="/commerce_order_admin/edit_commerce_order" />
							...
							<div class="align-items-center col-auto d-flex">
								...
								>
									<portlet:renderURL var="editURL">
										<portlet:param name="mvcRenderCommandName" value="/commerce_order_admin/edit_commerce_order_note" />
									...
									<portlet:actionURL name="/commerce_order_admin/edit_commerce_order_note" var="deleteURL">
