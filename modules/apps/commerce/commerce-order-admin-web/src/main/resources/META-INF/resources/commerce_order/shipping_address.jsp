...
<portlet:actionURL name="/commerce_order_admin/edit_commerce_order" var="editCommerceOrderShippingAddressActionURL" />
...
<div class="container-fluid container-fluid-max-xl p-4">
	<aui:form action="<%= editCommerceOrderShippingAddressActionURL %>" method="post" name="fm">
		...
		<frontend-data-set:classic-display
			...
			%>'
			creationMenu='<%= commerceOrderEditDisplayContext.getCommerceAddressCreationMenu("/commerce_order_admin/edit_commerce_order_shipping_address") %>'
