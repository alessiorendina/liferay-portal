...
<portlet:actionURL name="/commerce_order_type_admin/edit_commerce_order_type" var="editCommerceOrderTypeActionURL" />
...
>
	...
	<liferay-frontend:component
		...
		%>'
		module="{addCommerceOrderType} from commerce-order-admin-web"
	/>
</commerce-ui:modal-content>