...
<liferay-portlet:renderURL var="editCommerceOrderTypeExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_order_type_admin/edit_commerce_order_type_external_reference_code" />
...
<liferay-frontend:component
	...
	%>'
	module="{editCommerceOrderType} from commerce-order-admin-web"
/>