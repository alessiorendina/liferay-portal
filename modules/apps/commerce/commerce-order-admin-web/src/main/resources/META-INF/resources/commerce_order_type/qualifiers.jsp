...
<portlet:actionURL name="/commerce_order_type_admin/edit_commerce_order_type_qualifiers" var="editCommerceOrderTypeQualifiersActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{qualifiers} from commerce-order-admin-web"
/>