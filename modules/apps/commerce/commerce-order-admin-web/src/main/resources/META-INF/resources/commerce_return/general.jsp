...
<portlet:actionURL name="/commerce_return_admin/edit_commerce_return" var="editCommerceReturnActionURL" />
				...
				<div class="row vertically-divided">
					...
					<div class="col-xl-4">
						...
						<liferay-portlet:renderURL var="editCommerceReturnNoteURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
							<portlet:param name="mvcRenderCommandName" value="/commerce_return_admin/edit_commerce_return_note" />
		...
		<div class="col-12">
			...
			>
				<frontend-data-set:headless-display
					...
					propsTransformer="{commerceReturnItemsPropsTransformer} from commerce-order-admin-web"
					style="fluid"
				/>
			</commerce-ui:panel>
		</div>
