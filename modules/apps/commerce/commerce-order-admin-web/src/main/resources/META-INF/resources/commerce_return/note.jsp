...
<portlet:actionURL name="/commerce_return_admin/edit_commerce_return_note" var="editCommerceReturnNoteURL" />

<commerce-ui:modal-content>
	<aui:form action="<%= editCommerceReturnNoteURL %>" cssClass="container-fluid container-fluid-max-xl p-0" method="post" name="fm">
