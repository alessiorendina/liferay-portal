...
<portlet:actionURL name="/commerce_return_admin/edit_commerce_return_item_comment" var="editCommerceReturnItemCommentActionURL">
	<portlet:param name="mvcRenderCommandName" value="/commerce_return_admin/edit_commerce_item_comment" />
</portlet:actionURL>
