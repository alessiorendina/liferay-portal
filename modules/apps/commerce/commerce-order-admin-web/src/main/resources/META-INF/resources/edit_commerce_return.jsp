...
<liferay-portlet:renderURL var="editCommerceReturnExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_return_admin/edit_commerce_return_external_reference_code" />
...
<liferay-frontend:component
	module="{editCommerceReturn} from commerce-order-admin-web"
/>