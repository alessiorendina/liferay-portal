...
package com.liferay.commerce.order.rule.admin.web.internal.application.list;
...
public class COREntryPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return COREntryPortletKeys.COR_ENTRY_ADMIN;
	}

	@Reference(
		target = "(javax.portlet.name=" + COREntryPortletKeys.COR_ENTRY_ADMIN + ")"
	)
