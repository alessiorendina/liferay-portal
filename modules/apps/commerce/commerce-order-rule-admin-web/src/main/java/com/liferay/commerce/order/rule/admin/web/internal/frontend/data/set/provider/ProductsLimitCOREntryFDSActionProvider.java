...
package com.liferay.commerce.order.rule.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.order.rule.admin.web.internal.constants.COREntryFDSNames;
import com.liferay.commerce.order.rule.admin.web.internal.frontend.model.Product;
	...
	private String _getConfigurableProductDeleteURL(
		...
		return PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				httpServletRequest, COREntryPortletKeys.COR_ENTRY_ADMIN,
				PortletRequest.ACTION_PHASE)
		).setActionName(
			"/cor_entry_admin/edit_cor_entry"
		).setCMD(
			"deleteProduct"
		).setRedirect(
			ParamUtil.getString(
