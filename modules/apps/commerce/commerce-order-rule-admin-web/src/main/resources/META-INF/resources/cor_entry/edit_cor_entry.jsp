...
<liferay-portlet:renderURL var="editCOREntryExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/cor_entry_admin/edit_cor_entry_external_reference_code" />
...
<liferay-frontend:component
	...
	%>'
	module="{editCOREntry} from commerce-order-rule-admin-web"
/>