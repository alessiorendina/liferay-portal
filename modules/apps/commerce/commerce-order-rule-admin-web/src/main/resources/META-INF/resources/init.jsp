...
page import="com.liferay.commerce.order.rule.admin.web.internal.constants.COREntryFDSNames" %><%@
page import="com.liferay.commerce.order.rule.admin.web.internal.display.context.COREntryDisplayContext" %><%@
page import="com.liferay.commerce.order.rule.admin.web.internal.display.context.COREntryQualifiersDisplayContext" %><%@
page import="com.liferay.commerce.order.rule.admin.web.internal.entry.constants.COREntryScreenNavigationEntryConstants" %><%@
