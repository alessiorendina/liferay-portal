...
public class CommerceOrderRuleEntryServiceHttp {
	...
	public static com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry
			addCommerceOrderRuleEntry(
				HttpPrincipal httpPrincipal, boolean active, String description,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, active, description, name, priority, type,
	...
	public static java.util.List
		<com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry>
			getCommerceOrderRuleEntries(
				HttpPrincipal httpPrincipal, boolean active, int start, int end,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, active, start, end, serviceContext);
	...
	public static java.util.List
		<com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry>
			getCommerceOrderRuleEntries(
				HttpPrincipal httpPrincipal, boolean active, String type,
				int start, int end,
				com.liferay.portal.kernel.service.ServiceContext
					serviceContext) {
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, active, type, start, end, serviceContext);
	...
	public static java.util.List
		<com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry>
			getCommerceOrderRuleEntries(
				HttpPrincipal httpPrincipal, String type, int start, int end,
				com.liferay.portal.kernel.service.ServiceContext
					serviceContext) {
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, type, start, end, serviceContext);
	...
	private static final Class<?>[] _addCommerceOrderRuleEntryParameterTypes0 =
		new Class[] {
			boolean.class, String.class, String.class, int.class, String.class,
