...
import com.liferay.commerce.order.web.internal.portlet.configuration.CommerceOrderPortletInstanceConfiguration;
import com.liferay.commerce.order.web.internal.portlet.configuration.OpenCommerceOrderPortletInstanceConfiguration;
...
public class CommerceOrderDisplayContext {
	...
	public String getDisplayStyle(String portletId)
		...
		else if (portletId.equals(CommercePortletKeys.COMMERCE_OPEN_ORDER)) {
			OpenCommerceOrderPortletInstanceConfiguration
				openCommerceOrderPortletInstanceConfiguration =
					_configurationProvider.getPortletInstanceConfiguration(
						OpenCommerceOrderPortletInstanceConfiguration.class,
						_themeDisplay);

			return openCommerceOrderPortletInstanceConfiguration.displayStyle();
		}
		else if (portletId.equals(CommercePortletKeys.COMMERCE_ORDER)) {
			CommerceOrderPortletInstanceConfiguration
				commerceOrderPortletInstanceConfiguration =
					_configurationProvider.getPortletInstanceConfiguration(
						CommerceOrderPortletInstanceConfiguration.class,
						_themeDisplay);

			return commerceOrderPortletInstanceConfiguration.displayStyle();
		}
	...
	public String getDisplayStyleGroupKey(String portletId)
		...
		if (portletId.equals(CommercePortletKeys.COMMERCE_OPEN_ORDER)) {
			OpenCommerceOrderPortletInstanceConfiguration
				openCommerceOrderPortletInstanceConfiguration =
					_configurationProvider.getPortletInstanceConfiguration(
						OpenCommerceOrderPortletInstanceConfiguration.class,
			...
			dropdownItems.add(
				DropdownItemBuilder.setHref(
					PortletURLBuilder.createActionURL(
						...
						"/commerce_open_order/edit_commerce_order_item"
					).setCMD(
						Constants.RESET
					).setRedirect(
						PortalUtil.getCurrentURL(_cpRequestHelper.getRequest())
			...
			dropdownItems.add(
				DropdownItemBuilder.setHref(
					ResourceURLBuilder.createResourceURL(
						...
						"/commerce_order/export_commerce_order_report"
					).buildString()
				).setLabel(
	...
	public boolean isOpenOrderPortlet() {
		String portletName = _cpRequestHelper.getPortletName();

		return portletName.equals(CommercePortletKeys.COMMERCE_OPEN_ORDER);
	}
	...
	public boolean isShowCommerceOrderCreateTime() throws PortalException {
		...
		return commerceOrderPortletInstanceConfiguration.
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceOrderDisplayContext.class);
