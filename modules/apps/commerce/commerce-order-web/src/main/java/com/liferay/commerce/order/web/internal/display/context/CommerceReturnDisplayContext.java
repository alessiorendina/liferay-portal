 ...
 */
public class CommerceReturnDisplayContext {

	public CommerceReturnDisplayContext(
			...
			return ListUtil.fromArray(
				...
				new FDSActionDropdownItem(
					PortletURLBuilder.create(
						...
						"/commerce_return/view_commerce_refund"
					).setParameter(
	...
	public String getViewReturnableOrderItemsURL() throws PortalException {
		...
		return PortletURLBuilder.create(
			PortletURLFactoryUtil.create(
				_cpRequestHelper.getRequest(),
				CommercePortletKeys.COMMERCE_ORDER, PortletRequest.RENDER_PHASE)
		).setMVCRenderCommandName(
			"/commerce_order/view_returnable_commerce_order_items"
		).setParameter(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceReturnDisplayContext.class);
