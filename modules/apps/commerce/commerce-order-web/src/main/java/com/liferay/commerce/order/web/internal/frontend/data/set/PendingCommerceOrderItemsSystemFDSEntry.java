...
package com.liferay.commerce.order.web.internal.frontend.data.set;
 ...
 */
@Component(
	property = "frontend.data.set.name=" + CommerceOrderFragmentFDSNames.PENDING_ORDER_ITEMS,
...
public class PendingCommerceOrderItemsSystemFDSEntry implements SystemFDSEntry {
	...
	public String getName() {
		return CommerceOrderFragmentFDSNames.PENDING_ORDER_ITEMS;
	}
	...
	public String getRESTEndpoint() {
		return "/v1.0/carts/{cartId}/items";
	}
