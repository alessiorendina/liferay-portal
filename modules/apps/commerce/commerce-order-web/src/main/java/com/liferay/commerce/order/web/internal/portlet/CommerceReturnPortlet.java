...
import com.liferay.commerce.order.web.internal.display.context.CommerceReturnDisplayContext;
...
@Component(
	property = {
		...
		"jakarta.portlet.version=4.0", "javax.portlet.display-name=Returns",
...
public class CommerceReturnPortlet extends MVCPortlet {
	...
	public void render(
		...
		if (!FeatureFlagManagerUtil.isEnabled("LPD-10562")) {
			...
			try {
				CommerceReturnDisplayContext commerceReturnDisplayContext =
					new CommerceReturnDisplayContext(
