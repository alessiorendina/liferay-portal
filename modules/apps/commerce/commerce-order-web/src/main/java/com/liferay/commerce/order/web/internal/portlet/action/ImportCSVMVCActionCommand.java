...
import com.liferay.commerce.order.web.internal.importer.type.util.CommerceOrderImporterTypeUtil;
...
@Component(
	...
	property = {
		...
		"mvc.command.name=/commerce_open_order/import_csv"
	},
	...
	private String _getPreviewCommerceOrderRedirect(
		...
		return PortletURLBuilder.create(
			PortletURLFactoryUtil.create(
				actionRequest, CommercePortletKeys.COMMERCE_OPEN_ORDER,
