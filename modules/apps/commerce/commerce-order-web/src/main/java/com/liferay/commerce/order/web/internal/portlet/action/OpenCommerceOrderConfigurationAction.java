...
public class OpenCommerceOrderConfigurationAction
		...
		try {
			CommerceOrderDisplayContext commerceOrderDisplayContext =
				new CommerceOrderDisplayContext(
					...
					_commerceOrderNoteService, _commerceOrderPriceCalculation,
					...
					_commercePaymentMethodRegistry, _commerceTermEntryService,
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OpenCommerceOrderConfigurationAction.class);
