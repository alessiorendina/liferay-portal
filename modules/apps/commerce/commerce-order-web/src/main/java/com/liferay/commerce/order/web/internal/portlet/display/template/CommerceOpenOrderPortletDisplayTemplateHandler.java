...
package com.liferay.commerce.order.web.internal.portlet.display.template;

import com.liferay.commerce.constants.CommercePortletKeys;
import com.liferay.commerce.model.CommerceOrder;
import com.liferay.commerce.order.web.internal.display.context.CommerceOrderDisplayContext;
import com.liferay.commerce.order.web.internal.portlet.CommerceOpenOrderPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CommercePortletKeys.COMMERCE_OPEN_ORDER,
	service = TemplateHandler.class
)
public class CommerceOpenOrderPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CommerceOpenOrderPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CommercePortletKeys.COMMERCE_OPEN_ORDER, resourceBundle));
	...
	public String getResourceName() {
		return CommercePortletKeys.COMMERCE_OPEN_ORDER;
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"commerce-order-display-context", CommerceOrderDisplayContext.class,
			"commerceOrderDisplayContext");
