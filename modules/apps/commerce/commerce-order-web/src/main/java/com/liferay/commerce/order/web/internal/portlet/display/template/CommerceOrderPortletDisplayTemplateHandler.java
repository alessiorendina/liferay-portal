...
import com.liferay.commerce.order.web.internal.portlet.CommerceOrderPortlet;
...
public class CommerceOrderPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CommerceOrderPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CommercePortletKeys.COMMERCE_ORDER, resourceBundle));
