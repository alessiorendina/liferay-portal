...
<%
CommerceChannel commerceChannel = commerceOrderDisplayContext.fetchCommerceChannel();
%>
...
>
	...
	<aui:form action="<%= editCommerceOrderURL %>" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + liferayPortletResponse.getNamespace() + "addOrder();" %>'>
		...
		<aui:select label="order-type" name="commerceOrderTypeId">
			...
			<%
			for (CommerceOrderType orderType : commerceOrderDisplayContext.getCommerceOrderTypes()) {
			%>
...
<liferay-frontend:component
	context='<%=
		HashMapBuilder.<String, Object>put(
			"accountId", commerceOrderDisplayContext.getCommerceAccountId()
		).put(
