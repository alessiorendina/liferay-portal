...
<%
CommerceOrderNote commerceOrderNote = commerceOrderDisplayContext.getCommerceOrderNote();

PortletURL backURL = PortletURLBuilder.createRenderURL(
	renderResponse
).setMVCRenderCommandName(
	"/commerce_open_order/edit_commerce_order_notes"
).setParameter(
	"commerceOrderId", commerceOrderNote.getCommerceOrderId()
).buildPortletURL();
%>

<portlet:actionURL name="/commerce_open_order/edit_commerce_order_note" var="editCommerceOrderNoteActionURL">
		...
		<div class="sheet">
			<div class="panel-group panel-group-flush">
				<aui:fieldset>
					...
					<c:if test="<%= commerceOrderDisplayContext.hasModelPermission(commerceOrderNote.getCommerceOrderId(), CommerceOrderActionKeys.MANAGE_COMMERCE_ORDER_RESTRICTED_NOTES) %>">
