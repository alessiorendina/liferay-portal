...
boolean manageNotesPermission = commerceOrderDisplayContext.hasModelPermission(commerceOrder, CommerceOrderActionKeys.MANAGE_COMMERCE_ORDER_NOTES);
boolean manageRestrictedNotesPermission = commerceOrderDisplayContext.hasModelPermission(commerceOrder, CommerceOrderActionKeys.MANAGE_COMMERCE_ORDER_RESTRICTED_NOTES);
...
<portlet:actionURL name="/commerce_open_order/edit_commerce_order_note" var="editCommerceOrderNoteURL">
...
<aui:form action="<%= editCommerceOrderNoteURL %>" cssClass="order-notes-form" method="post" name="fm">
	...
	<div class="taglib-discussion">
		...
		for (CommerceOrderNote commerceOrderNote : commerceOrderDisplayContext.getCommerceOrderNotes(commerceOrder)) {
		%>
							...
							<div class="card-col-field">
								...
								>
									<portlet:renderURL var="editURL">
										<portlet:param name="mvcRenderCommandName" value="/commerce_open_order/edit_commerce_order_note" />
									...
									<portlet:actionURL name="/commerce_open_order/edit_commerce_order_note" var="deleteURL">
