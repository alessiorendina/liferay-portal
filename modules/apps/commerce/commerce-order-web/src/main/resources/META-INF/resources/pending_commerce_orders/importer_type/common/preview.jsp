...
CommerceOrderImporterType commerceOrderImporterType = commerceOrderDisplayContext.getCommerceOrderImporterType(commerceOrderImporterTypeKey);
%>
...
<c:if test="<%= commerceOrderImporterType != null %>">
	...
	<portlet:actionURL name="/commerce_open_order/import_commerce_order_items" var="importCommerceOrderItemsActionURL">
	...
	<aui:form action="<%= importCommerceOrderItemsActionURL %>" method="post" name="fm">
		...
		<aui:input name="commerceOrderId" type="hidden" value="<%= commerceOrderDisplayContext.getCommerceOrderId() %>" />
			...
			<frontend-data-set:classic-display
				contextParams='<%=
					HashMapBuilder.<String, String>put(
						"commerceOrderId", String.valueOf(commerceOrderDisplayContext.getCommerceOrderId())
					).put(
