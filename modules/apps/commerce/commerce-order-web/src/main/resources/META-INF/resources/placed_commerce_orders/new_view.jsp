		...
		>
			<div class="row vertically-divided">
				...
				<div class="col-xl-4">
					...
					<c:if test="<%= commerceOrderDisplayContext.hasViewBillingAddressPermission(permissionChecker, accountEntry) && (billingCommerceAddress != null) %>">
						<commerce-ui:info-box
							elementClasses="py-3"
					...
					<commerce-ui:info-box
						...
						actionUrl="<%= (commerceOrderDisplayContext.hasManageCommerceOrderPaymentTermsPermission() && (commerceOrder.getPaymentCommerceTermEntryId() > 0)) ? editPaymentTermsURL : null %>"
						elementClasses="py-3"
					...
					<commerce-ui:info-box
						...
						actionUrl="<%= (commerceOrderDisplayContext.hasManageCommerceOrderDeliveryTermsPermission() && (commerceOrder.getDeliveryCommerceTermEntryId() > 0)) ? editDeliveryTermsURL : null %>"
						elementClasses="py-3"
				...
				<div class="col-xl-4">
					...
					<portlet:renderURL var="viewCommerceOrderNotesURL">
						<portlet:param name="mvcRenderCommandName" value="/commerce_order/view_commerce_order_notes" />
						<portlet:param name="redirect" value="<%= currentURL %>" />
						<portlet:param name="commerceOrderId" value="<%= String.valueOf(commerceOrder.getCommerceOrderId()) %>" />
					</portlet:renderURL>

					<%
					List<CommerceOrderNote> commerceOrderNotes = commerceOrderDisplayContext.getCommerceOrderNotes(commerceOrder);
					%>
