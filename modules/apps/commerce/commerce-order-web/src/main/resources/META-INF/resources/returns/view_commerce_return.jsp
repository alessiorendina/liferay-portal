...
CommerceReturn commerceReturn = commerceReturnDisplayContext.getCommerceReturn();
...
<commerce-ui:header
	actions="<%= commerceReturnDisplayContext.getHeaderActionModels() %>"
...
<div class="container mt-4">
	<aui:form cssClass="pt-4" method="post" name="fm">
		...
		<aui:input name="commerceReturnId" type="hidden" value="<%= commerceReturnDisplayContext.getCommerceReturnItemId() %>" />
				...
				>
					<div class="row vertically-divided">
						<div class="col-4">
							...
							>
								<p class="mb-0"><%= String.valueOf(
									commerceReturnDisplayContext.getAccountEntryName()) %></p>
							...
							>
								<p class="mb-0"><%= commerceReturnDisplayContext.getShippingAddress() %></p>
							</commerce-ui:info-box>
						</div>
						...
						<div class="col-4">
							...
							>
								<p class="mb-0"><%= commerceReturnDisplayContext.getOrderDate() %></p>
							</commerce-ui:info-box>
							...
							>
								<p class="mb-0"><%= commerceReturnDisplayContext.getPaymentMethod() %></p>
							</commerce-ui:info-box>
						</div>
						...
						<div class="col-4">
							<liferay-portlet:renderURL var="editCommerceReturnNoteURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
								...
								<portlet:param name="commerceReturnId" value="<%= String.valueOf(commerceReturnDisplayContext.getCommerceReturnId()) %>" />
				...
				>
					<div id="<portlet:namespace />return-items-container">
						<frontend-data-set:headless-display
							apiURL="<%= commerceReturnDisplayContext.getReturnItemsAPIURL() %>"
							creationMenu="<%= commerceReturnDisplayContext.getCommerceReturnItemCreationMenu() %>"
							fdsActionDropdownItems="<%= commerceReturnDisplayContext.getCommerceReturnItemFDSActionDropdownItems() %>"
							formName="fm"
						...
						<liferay-frontend:component
							context='<%=
								HashMapBuilder.<String, Object>put(
									...
									"returnableOrderItemsContextParams", commerceReturnDisplayContext.getReturnableOrderItemsContextParams()
								).put(
									"viewReturnableOrderItemsURL", commerceReturnDisplayContext.getViewReturnableOrderItemsURL()
								).build()
							%>'
				...
				>
					<div class="row summary-table text-right">
						...
						<div class="col-6 col-md-3">
							<span class="summary-table-item"><%= commerceReturnDisplayContext.getUnitsReturned() %></span>
						</div>
					</div>
					...
					<div class="row summary-table text-right">
						...
						<div class="col-6 col-md-3">
							<span class="summary-table-item"><%= commerceReturnDisplayContext.getRefundSubtotal() %></span>
						</div>
					</div>
					...
					<div class="row summary-table text-right">
						...
						<div class="col-6 col-md-3">
							<div class="h4 my-2 summary-table-item-big"><%= commerceReturnDisplayContext.getTotalEstimatedRefund() %></div>
						</div>
					</div>
				</commerce-ui:panel>
			</div>
...
<liferay-frontend:component
	context='<%=
		HashMapBuilder.<String, Object>put(
			"commerceReturnId", commerceReturnDisplayContext.getCommerceReturnId()
		).put(
