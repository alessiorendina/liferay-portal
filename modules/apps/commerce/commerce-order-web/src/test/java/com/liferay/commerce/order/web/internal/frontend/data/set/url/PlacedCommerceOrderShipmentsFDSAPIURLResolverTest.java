...
package com.liferay.commerce.order.web.internal.frontend.data.set.url;
 ...
 */
public class PlacedCommerceOrderShipmentsFDSAPIURLResolverTest {
		...
		Assert.assertEquals(
			_placedCommerceOrderItemsFDSAPIURLResolver.resolve(
				"/v1.0/placed-orders/by-externalReferenceCode" +
					"/{externalReferenceCode}/shipments",
				_mockHttpServletRequest),
			StringBundler.concat(
				"/v1.0/placed-orders/by-externalReferenceCode/",
				_commerceOrder.getExternalReferenceCode(), "/shipments"));
		Assert.assertEquals(
			_placedCommerceOrderItemsFDSAPIURLResolver.resolve(
				"/v1.0/placed-orders/{placedOrderId}/shipments",
				_mockHttpServletRequest),
			StringBundler.concat(
