...
import com.liferay.commerce.payment.admin.web.internal.display.context.CommercePaymentEntryDisplayContext;
...
@Component(
	property = {
		...
		"javax.portlet.name=" + CommercePortletKeys.COMMERCE_PAYMENT_ADMIN,
...
public class CommercePaymentAdminPortlet extends MVCPortlet {
