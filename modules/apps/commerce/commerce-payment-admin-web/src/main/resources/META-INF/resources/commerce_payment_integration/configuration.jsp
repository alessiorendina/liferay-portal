...
<portlet:actionURL name="/commerce_payment_admin/edit_function_commerce_payment_integration_configuration" var="editFunctionCommercePaymentIntegrationActionURL" />
