...
<liferay-portlet:renderURL var="editCommercePaymentEntryExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_payment_admin/edit_commerce_payment_entry_external_reference_code" />
...
<div class="container mt-4">
	<portlet:actionURL name="/commerce_payment_admin/edit_commerce_payment_entry" var="editCommercePaymentEntryActionURL" />
					...
					<div class="row vertically-divided">
						...
						<div class="col-6">
							...
							<liferay-portlet:renderURL var="editCommercePaymentEntryNoteURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
								<portlet:param name="mvcRenderCommandName" value="/commerce_payment_admin/edit_commerce_payment_entry_note" />
								<portlet:param name="commercePaymentEntryId" value="<%= String.valueOf(commercePaymentEntryDisplayContext.getCommercePaymentEntryId()) %>" />
							</liferay-portlet:renderURL>
			...
			<div class="col-12">
				...
				>
					<frontend-data-set:headless-display
						...
						propsTransformer="{commercePaymentPropsTransformer} from commerce-payment-admin-web"
						style="fluid"
					/>
				</commerce-ui:panel>
			</div>
...
<liferay-frontend:component
	...
	%>'
	module="{editCommercePaymentEntry} from commerce-payment-admin-web"
/>