...
<portlet:actionURL name="/commerce_payment_admin/edit_commerce_payment_entry_external_reference_code" var="editCommercePaymentEntryExternalReferenceCodeURL" />
