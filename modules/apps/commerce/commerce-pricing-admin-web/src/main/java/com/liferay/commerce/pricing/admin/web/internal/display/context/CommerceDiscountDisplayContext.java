...
package com.liferay.commerce.pricing.admin.web.internal.display.context;
...
import com.liferay.commerce.pricing.admin.web.internal.constants.CommerceDiscountScreenNavigationConstants;
...
public class CommerceDiscountDisplayContext extends BasePricingDisplayContext {
	...
	public String getAddCommerceDiscountRenderURL() throws Exception {
		return PortletURLBuilder.createRenderURL(
			...
			"/commerce_discount_admin/add_commerce_discount"
		).setWindowState(
	...
	public String getAddCommerceDiscountRuleRenderURL() throws Exception {
		return PortletURLBuilder.createRenderURL(
			...
			"/commerce_discount_admin/add_commerce_discount_rule"
		).setParameter(
		...
		return ListUtil.fromArray(
			new FDSActionDropdownItem(
				PortletURLBuilder.create(
					...
					"/commerce_discount_admin/edit_commerce_discount"
				).setRedirect(
					commercePricingRequestHelper.getCurrentURL()
				).setParameter(
	...
	public List<FDSActionDropdownItem>
		...
		return getFDSActionTemplates(
			PortletURLBuilder.create(
				...
				"/commerce_pricing_classes_admin/edit_commerce_pricing_class"
			).setRedirect(
				commercePricingRequestHelper.getCurrentURL()
			).setParameter(
	...
	public List<FDSActionDropdownItem> getDiscountRulesFDSActionDropdownItem()
		...
		PortletURL portletURL = PortletURLBuilder.create(
			...
			"/commerce_discount_admin/edit_commerce_discount_rule"
		).setRedirect(
			commercePricingRequestHelper.getCurrentURL()
		).setParameter(
	...
	public String getEditCommerceDiscountActionURL() throws Exception {
		...
		return PortletURLBuilder.create(
			portal.getControlPanelPortletURL(
				commercePricingRequestHelper.getRequest(),
				CommercePricingPortletKeys.COMMERCE_DISCOUNT_ADMIN,
