...
import com.liferay.commerce.pricing.admin.web.internal.display.context.CommerceDiscountDisplayContext;
...
@Component(
	property = {
		...
		"javax.portlet.name=" + CommercePricingPortletKeys.COMMERCE_DISCOUNT_ADMIN,
...
public class CommerceDiscountAdminPortlet extends MVCPortlet {
