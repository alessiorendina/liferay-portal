...
package com.liferay.commerce.pricing.admin.web.internal.portlet;

import com.liferay.commerce.pricing.admin.web.internal.display.context.CommercePricingClassDisplayContext;
...
@Component(
	property = {
		...
		"javax.portlet.name=" + CommercePricingPortletKeys.COMMERCE_PRICING_CLASSES_ADMIN,
...
public class CommercePricingClassesAdminPortlet extends MVCPortlet {
