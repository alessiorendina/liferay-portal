...
import com.liferay.commerce.pricing.admin.web.internal.display.context.CPInstanceCommerceTierPriceEntryDisplayContext;
...
@Component(
	property = {
		...
		"mvc.command.name=/cp_definitions_admin/edit_cp_instance_commerce_tier_price_entry"
	},
...
public class EditCPInstanceCommerceTierPriceEntryMVCRenderCommand
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.pricing.admin.web)"
	)
