...
<portlet:actionURL name="/commerce_discount_admin/edit_commerce_discount" var="editCommerceDiscountActionURL" />
...
>
	...
	<liferay-frontend:component
		...
		%>'
		module="{addCommerceDiscount} from commerce-pricing-admin-web"
	/>
</commerce-ui:modal-content>