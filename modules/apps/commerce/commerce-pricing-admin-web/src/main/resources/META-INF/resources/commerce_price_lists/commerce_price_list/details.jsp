...
<portlet:actionURL name="/commerce_price_list_admin/edit_commerce_price_list" var="editCommercePriceListActionURL" />
		...
		<div class="col-8">
			...
			>
				...
				<liferay-frontend:component
					...
					%>'
					module="{detailsAutocomplete} from commerce-pricing-admin-web"
				/>
