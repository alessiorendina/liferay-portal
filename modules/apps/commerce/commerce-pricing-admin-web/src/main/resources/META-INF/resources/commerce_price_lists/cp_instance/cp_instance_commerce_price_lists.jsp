...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_instance_commerce_price_entry" var="addCommercePriceEntryURL" />
...
<liferay-frontend:component
	...
	module="{cpInstanceCommercePriceLists} from commerce-pricing-admin-web"
/>