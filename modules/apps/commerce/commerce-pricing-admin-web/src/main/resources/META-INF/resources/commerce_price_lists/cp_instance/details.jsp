...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_instance_commerce_price_entry" var="editCommercePriceEntryActionURL" />
...
<liferay-frontend:component
	module="{PriceEntry} from commerce-pricing-admin-web"
/>