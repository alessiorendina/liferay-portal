...
<portlet:actionURL name="/commerce_pricing_classes_admin/edit_commerce_pricing_class" var="editCommercePricingClassActionURL" />
...
>
	...
	<liferay-frontend:component
		...
		%>'
		module="{addCommercePricingClass} from commerce-pricing-admin-web"
	/>
</commerce-ui:modal-content>