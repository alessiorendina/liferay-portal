...
<portlet:actionURL name="/commerce_pricing_classes_admin/edit_commerce_pricing_class_external_reference_code" var="editCommercePricingClassExternalReferenceCodeURL" />
