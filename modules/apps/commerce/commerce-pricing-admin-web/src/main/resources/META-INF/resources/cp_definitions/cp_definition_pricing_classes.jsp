...
<c:if test="<%= cpDefinitionPricingClassDisplayContext.hasPermission(permissionChecker, cpDefinition, ActionKeys.VIEW) %>">
	<div class="pt-4" id="<portlet:namespace />productPricingClassRelsContainer"><portlet:actionURL name="/cp_definitions_admin/edit_cp_definition" var="editProductDefinitionProductGroupsActionURL" />
		...
		<aui:form action="<%= editProductDefinitionProductGroupsActionURL %>" method="post" name="fm">
			...
			<liferay-frontend:component
				...
				%>'
				module="{cpDefinitionPricingClasses} from commerce-pricing-admin-web"
			/>
