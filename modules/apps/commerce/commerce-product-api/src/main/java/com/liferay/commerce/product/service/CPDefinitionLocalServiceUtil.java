...
public class CPDefinitionLocalServiceUtil {
	...
	public static void cloneAssetEntry(
		long oldCPDefinitionId, long newCPDefinitionId) {

		getService().cloneAssetEntry(oldCPDefinitionId, newCPDefinitionId);
	}
	...
	public static void cloneCPDefinitionLocalization(
		long oldCPDefinitionId, long newCPDefinitionId) {

		getService().cloneCPDefinitionLocalization(
	...
	public static CPDefinition copyCPDefinition(
		...
		return getService().copyCPDefinition(
			userId, cpDefinitionId, groupId, status);
	}
