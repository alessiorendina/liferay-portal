...
package com.liferay.commerce.product.asset.categories.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.product.asset.categories.admin.web.internal.constants.CommerceProductAssetCategoriesFDSNames;
import com.liferay.commerce.product.asset.categories.admin.web.internal.model.CategoryDisplayPage;
	...
	private String _getCategoryDisplayPageDeleteURL(
		...
		return PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				httpServletRequest, CPPortletKeys.COMMERCE_CHANNELS_ADMIN,
				PortletRequest.ACTION_PHASE)
		).setActionName(
			"/commerce_channels_admin/edit_asset_category_cp_display_layout"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
