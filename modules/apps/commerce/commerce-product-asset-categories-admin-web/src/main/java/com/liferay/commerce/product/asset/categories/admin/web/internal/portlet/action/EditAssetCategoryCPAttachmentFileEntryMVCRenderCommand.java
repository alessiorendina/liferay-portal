...
package com.liferay.commerce.product.asset.categories.admin.web.internal.portlet.action;

import com.liferay.commerce.product.asset.categories.admin.web.internal.constants.CommerceProductAssetCategoriesPortletKeys;
import com.liferay.commerce.product.asset.categories.admin.web.internal.display.context.CategoryCPAttachmentFileEntriesDisplayContext;
...
@Component(
	...
	property = {
		...
		"mvc.command.name=/commerce_product_asset_categories_admin/edit_asset_category_cp_attachment_file_entry"
	},
...
public class EditAssetCategoryCPAttachmentFileEntryMVCRenderCommand
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.product.asset.categories.admin.web)"
	)
