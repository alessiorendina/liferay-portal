...
>
	<portlet:renderURL var="editURL">
		<portlet:param name="mvcRenderCommandName" value="/commerce_product_asset_categories_admin/edit_asset_category_cp_attachment_file_entry" />
	...
	<portlet:actionURL name="/commerce_product_asset_categories_admin/edit_asset_category_cp_attachment_file_entry" var="deleteURL">
