...
package com.liferay.commerce.product.category.web.internal.display.context;
...
import com.liferay.commerce.product.category.web.internal.configuration.CPCategoryPortletInstanceConfiguration;
 ...
 */
public class CPCategoryDisplayContext {

	public CPCategoryDisplayContext(
		...
		_cpCategoryPortletInstanceConfiguration =
			ConfigurationProviderUtil.getPortletInstanceConfiguration(
				CPCategoryPortletInstanceConfiguration.class, _themeDisplay);
	}

	public AssetCategory getAssetCategory() throws PortalException {
		if (_cpCategoryPortletInstanceConfiguration.useAssetCategory()) {
			_assetCategory =
	...
	public String getDisplayStyle() {
		return _cpCategoryPortletInstanceConfiguration.displayStyle();
	}
	...
	public boolean useAssetCategory() {
		return _cpCategoryPortletInstanceConfiguration.useAssetCategory();
	}
	...
	private final CPCategoryPortletInstanceConfiguration
		_cpCategoryPortletInstanceConfiguration;
