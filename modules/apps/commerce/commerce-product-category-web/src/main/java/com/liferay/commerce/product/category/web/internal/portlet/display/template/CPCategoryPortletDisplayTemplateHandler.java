...
package com.liferay.commerce.product.category.web.internal.portlet.display.template;
...
import com.liferay.commerce.product.category.web.internal.portlet.CPCategoryPortlet;
...
public class CPCategoryPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CPCategoryPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(CPPortletKeys.CP_CATEGORY, resourceBundle));
	...
	public String getResourceName() {
		return CPPortletKeys.CP_CATEGORY;
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"cp-category-display-context", CPCategoryDisplayContext.class,
			"cpCategoryDisplayContext");
		templateVariableGroup.addVariable(
	...
	protected String getTemplatesConfigPath() {
		return "com/liferay/commerce/product/category/web/internal" +
