...
if (!cpCategoryDisplayContext.useAssetCategory()) {
					...
					<aui:fieldset>
						<div class="display-template">
							<liferay-template:template-selector
								...
								displayStyleGroupKey="<%= cpCategoryDisplayContext.getDisplayStyleGroupKey() %>"
						...
						<div id="<portlet:namespace />assetCategoryContainer">
							<div class="lfr-use-asset-category-header">
								<aui:input checked="<%= cpCategoryDisplayContext.useAssetCategory() %>" id="useAssetCategory" label="use-asset-category" name="preferences--useAssetCategory--" type="checkbox" />
							</div>
...
<liferay-frontend:component
	module="{configuration} from commerce-product-category-web"
/>