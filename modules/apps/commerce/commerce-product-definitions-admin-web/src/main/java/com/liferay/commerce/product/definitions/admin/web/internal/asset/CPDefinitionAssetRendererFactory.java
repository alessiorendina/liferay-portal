...
package com.liferay.commerce.product.definitions.admin.web.internal.asset;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CPPortletKeys.CP_DEFINITIONS_ADMIN,
...
public class CPDefinitionAssetRendererFactory
	...
	public CPDefinitionAssetRendererFactory() {
		...
		setLinkable(true);
		setPortletId(CPPortletKeys.CP_DEFINITIONS_ADMIN);
		setSearchable(true);
		setSelectable(false);
	}
	...
	public PortletURL getURLAdd(
		...
		return PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				...
				CPPortletKeys.CP_DEFINITIONS_ADMIN, 0, 0,
