...
package com.liferay.commerce.product.definitions.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.product.constants.CPPortletKeys;
import com.liferay.commerce.product.definitions.admin.web.internal.constants.CommerceProductFDSNames;
import com.liferay.commerce.product.definitions.admin.web.internal.model.ProductSpecification;
import com.liferay.commerce.product.definitions.admin.web.internal.security.permission.resource.CommerceCatalogPermission;
	...
	private PortletURL _getProductSpecificationDeleteURL(
		...
		return PortletURLBuilder.create(
			_portal.getControlPanelPortletURL(
				...
				CPPortletKeys.CP_DEFINITIONS_ADMIN, PortletRequest.ACTION_PHASE)
		).setActionName(
			"/cp_definitions_admin/edit_cp_definition_specification_option_value"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
