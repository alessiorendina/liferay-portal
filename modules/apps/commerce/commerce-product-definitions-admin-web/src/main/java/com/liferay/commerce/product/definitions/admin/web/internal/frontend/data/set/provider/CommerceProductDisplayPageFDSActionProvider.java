...
import com.liferay.commerce.product.definitions.admin.web.internal.model.ProductDisplayPage;
...
public class CommerceProductDisplayPageFDSActionProvider
	...
	private String _getProductDisplayPageDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_channels_admin/edit_cp_definition_cp_display_layout"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
