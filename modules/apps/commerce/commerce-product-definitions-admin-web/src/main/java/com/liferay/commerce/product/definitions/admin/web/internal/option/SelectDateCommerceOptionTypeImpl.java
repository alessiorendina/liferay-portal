...
package com.liferay.commerce.product.definitions.admin.web.internal.option;
...
@Component(
	property = {
		"commerce.option.type.display.order:Integer=800",
		"commerce.option.type.key=" + CPConstants.PRODUCT_OPTION_SELECT_DATE_KEY
	},
	service = CommerceOptionType.class
)
public class SelectDateCommerceOptionTypeImpl implements CommerceOptionType {

	@Override
	public String getKey() {
		return CPConstants.PRODUCT_OPTION_SELECT_DATE_KEY;
	}

	@Override
	public String getLabel(Locale locale) {
		return _language.get(locale, "select-date-from-list");
	}
	...
	public void render(
		...
		if (CPPortletKeys.CP_DEFINITIONS_ADMIN.equals(
		...
		_reactRenderer.renderReact(
			...
			HashMapBuilder.<String, Object>put(
				...
				"isAdmin",
				CPPortletKeys.CP_DEFINITIONS_ADMIN.equals(
					portletDisplay.getPortletName())
			).put(
				"json", json
			).put(
