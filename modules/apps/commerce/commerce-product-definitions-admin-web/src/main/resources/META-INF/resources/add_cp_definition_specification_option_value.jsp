...
>
	<aui:form cssClass="container-fluid container-fluid-max-xl" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + liferayPortletResponse.getNamespace() + "apiSubmit();" %>'>
		<react:component
			module="{CPDefinitionSpecificationOptionValueAutocomplete} from commerce-product-definitions-admin-web"
			props='<%=
	...
	<liferay-frontend:component
		...
		%>'
		module="{addCPDefinitionSpecificationOptionValue} from commerce-product-definitions-admin-web"
	/>
</commerce-ui:modal-content>