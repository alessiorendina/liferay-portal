...
<portlet:actionURL name="/cp_configuration_list_admin/edit_cp_configuration_list_qualifiers" var="editCPConfigurationListQualifiersActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{qualifiers} from commerce-product-definitions-admin-web"
/>
