...
>
	...
	<portlet:renderURL var="editProductDefinitionURL">
		<portlet:param name="mvcRenderCommandName" value="/cp_definitions_admin/edit_cp_definition" />
	</portlet:renderURL>
	...
	<liferay-frontend:component
		...
		%>'
		module="{duplicateCpDefinitionAutocomplete} from commerce-product-definitions-admin-web"
	/>
</commerce-ui:modal-content>