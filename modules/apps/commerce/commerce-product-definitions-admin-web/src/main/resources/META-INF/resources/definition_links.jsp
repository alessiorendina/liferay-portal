...
<c:if test="<%= CommerceCatalogPermission.contains(permissionChecker, cpDefinition, ActionKeys.VIEW) %>">
	<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition_link" var="addCPDefinitionLinkURL" />
	...
	<div class="pt-4" id="<portlet:namespace />productDefinitionLinksContainer">
		<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition" var="editProductDefinitionLinksActionURL" />
