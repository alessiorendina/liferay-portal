...
>
	<portlet:actionURL name="/commerce_channels_admin/edit_cp_definition_cp_display_layout" var="editCPDefinitionCPDisplayLayoutActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{EditDisplayLayout} from commerce-product-definitions-admin-web"
/>