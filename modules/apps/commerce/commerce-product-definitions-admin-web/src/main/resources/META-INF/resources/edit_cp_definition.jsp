...
<liferay-portlet:renderURL var="editCProductExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/cp_definitions_admin/edit_c_product_external_reference_code" />
...
<liferay-frontend:component
	...
	%>'
	module="{editCpDefinition} from commerce-product-definitions-admin-web"
/>