...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition_option_rel" var="editProductDefinitionOptionRelActionURL" />
...
>
	<aui:form action="<%= editProductDefinitionOptionRelActionURL %>" method="post" name="fm">
		...
		<portlet:renderURL var="redirectURL">
			<portlet:param name="mvcRenderCommandName" value="/cp_definitions_admin/edit_cp_definition_option_rel" />
