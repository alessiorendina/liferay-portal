...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition_specification_option_value" var="editProductDefinitionSpecificationOptionValueActionURL" />
		...
		<aui:form action="<%= editProductDefinitionSpecificationOptionValueActionURL %>" method="post" name="fm">
			...
			<c:choose>
				...
				<c:otherwise>
					<div>
						<react:component
							module="{CPDefinitionSpecificationOptionValueGroupOption} from commerce-product-definitions-admin-web"
							props='<%=
