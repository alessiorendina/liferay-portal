...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition" var="editProductDefinitionActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{editCpDefinitionVisibility} from commerce-product-definitions-admin-web"
/>