...
>
	<portlet:actionURL name="/cp_definitions_admin/edit_cp_instance_unit_of_measure" var="editCPInstanceUnitOfMeasureActionURL" />
	...
	<liferay-frontend:component
		...
		%>'
		module="{editCpInstanceUnitOfMeasure} from commerce-product-definitions-admin-web"
	/>
</liferay-frontend:side-panel-content>