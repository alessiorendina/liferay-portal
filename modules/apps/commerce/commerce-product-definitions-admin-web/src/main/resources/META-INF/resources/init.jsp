...
page import="com.liferay.commerce.product.definitions.admin.web.internal.constants.CPConfigurationFDSNames" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.constants.CommerceProductFDSNames" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPAttachmentFileEntriesDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPConfigurationListDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPConfigurationListQualifiersDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionConfigurationDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionDisplayLayoutDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionLinkDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionOptionRelDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionOptionValueRelDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionSpecificationOptionValueDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPDefinitionsDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPInstanceDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.display.context.CPInstanceUnitOfMeasureDisplayContext" %><%@
page import="com.liferay.commerce.product.definitions.admin.web.internal.security.permission.resource.CommerceCatalogPermission" %><%@
