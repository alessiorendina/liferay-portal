...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_instance" var="editProductInstanceActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{InstanceDetails} from commerce-product-definitions-admin-web"
/>