...
package com.liferay.commerce.product.measurement.unit.admin.web.internal.display.context;

import com.liferay.commerce.product.constants.CPActionKeys;
import com.liferay.commerce.product.constants.CPMeasurementUnitConstants;
import com.liferay.commerce.product.constants.CPPortletKeys;
import com.liferay.commerce.product.measurement.unit.admin.web.internal.util.CPMeasurementUnitUtil;
...
public class CPMeasurementUnitsDisplayContext {
	...
	public String getOrderByCol() {
		...
		_orderByCol = SearchOrderByUtil.getOrderByCol(
			_renderRequest, CPPortletKeys.CP_MEASUREMENT_UNIT_ADMIN,
			"priority");
	...
	public String getOrderByType() {
		...
		_orderByType = SearchOrderByUtil.getOrderByType(
			_renderRequest, CPPortletKeys.CP_MEASUREMENT_UNIT_ADMIN, "asc");
