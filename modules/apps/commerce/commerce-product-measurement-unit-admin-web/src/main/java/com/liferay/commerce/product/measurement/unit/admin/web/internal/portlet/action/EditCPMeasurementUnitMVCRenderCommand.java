...
package com.liferay.commerce.product.measurement.unit.admin.web.internal.portlet.action;
...
@Component(
	property = {
		...
		"mvc.command.name=/cp_measurement_unit_admin/edit_cp_measurement_unit"
	},
		...
		portletDisplay.setURLBack(
			PortletURLBuilder.create(
				_portal.getControlPanelPortletURL(
					renderRequest, CPPortletKeys.CP_MEASUREMENT_UNIT_ADMIN,
