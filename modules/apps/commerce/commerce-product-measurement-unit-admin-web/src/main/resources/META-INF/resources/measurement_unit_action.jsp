...
>
	<c:if test="<%= cpMeasurementUnitsDisplayContext.hasManageCPMeasurementUnitsPermission() %>">
		<portlet:renderURL var="editURL">
			<portlet:param name="mvcRenderCommandName" value="/cp_measurement_unit_admin/edit_cp_measurement_unit" />
		...
		<portlet:actionURL name="/cp_measurement_unit_admin/edit_cp_measurement_unit" var="setPrimaryURL">
		...
		<portlet:actionURL name="/cp_measurement_unit_admin/edit_cp_measurement_unit" var="deleteURL">
