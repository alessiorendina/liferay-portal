...
<c:if test="<%= cpMeasurementUnitsDisplayContext.hasManageCPMeasurementUnitsPermission() %>">
	...
	<clay:management-toolbar
		...
		propsTransformer="{CPMeasurementUnitsManagementToolbarPropsTransformer} from commerce-product-measurement-unit-admin-web"
	/>

	<div class="container-fluid container-fluid-max-xl">
		<portlet:actionURL name="/cp_measurement_unit_admin/edit_cp_measurement_unit" var="editCPMeasurementUnitActionURL" />
					...
					<liferay-ui:search-container-column-text
						...
						href='<%=
							PortletURLBuilder.createRenderURL(
								...
								"/cp_measurement_unit_admin/edit_cp_measurement_unit"
							).setParameter(
