...
import com.liferay.commerce.product.options.admin.web.internal.display.context.CPOptionDisplayContext;
...
@Component(
	property = {
		...
		"javax.portlet.name=" + CPPortletKeys.CP_OPTIONS_ADMIN,
...
public class CPOptionsAdminPortlet extends MVCPortlet {
