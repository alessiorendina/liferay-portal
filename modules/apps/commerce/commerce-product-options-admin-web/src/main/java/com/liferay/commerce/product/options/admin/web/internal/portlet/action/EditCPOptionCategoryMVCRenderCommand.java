...
package com.liferay.commerce.product.options.admin.web.internal.portlet.action;
...
import com.liferay.commerce.product.options.admin.web.internal.display.context.CPOptionCategoryDisplayContext;
import com.liferay.commerce.product.options.admin.web.internal.portlet.action.helper.ActionHelper;
...
@Component(
	property = {
		"javax.portlet.name=" + CPPortletKeys.CP_SPECIFICATION_OPTIONS_ADMIN,
		"mvc.command.name=/cp_specification_options_admin/edit_cp_option_category"
	},
		...
		portletDisplay.setURLBack(
			PortletURLBuilder.create(
				_portal.getControlPanelPortletURL(
					renderRequest, CPPortletKeys.CP_SPECIFICATION_OPTIONS_ADMIN,
					PortletRequest.RENDER_PHASE)
			).setMVCRenderCommandName(
				"/cp_specification_options_admin/view_cp_option_categories"
			).setParameter(
