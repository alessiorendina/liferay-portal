...
<portlet:actionURL name="/cp_options_admin/edit_cp_option" var="editOptionActionURL" />

<liferay-portlet:renderURL var="editCPOptionExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/cp_options_admin/edit_cp_option_external_reference_code" />
...
<liferay-frontend:component
	module="{editCpOptionAndValue} from commerce-product-options-admin-web"
/>