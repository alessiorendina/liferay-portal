...
<portlet:actionURL name="/cp_specification_options_admin/edit_cp_specification_option" var="editProductSpecificationOptionActionURL" />
...
<liferay-frontend:component
	module="{EditCPSpecificationOption} from commerce-product-options-admin-web"
/>