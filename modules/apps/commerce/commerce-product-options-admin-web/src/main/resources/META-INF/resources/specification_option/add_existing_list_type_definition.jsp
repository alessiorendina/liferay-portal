...
>
	<aui:form method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + liferayPortletResponse.getNamespace() + "storeToParentForm(this.form);" %>' useNamespace="<%= false %>">
		<div class="py-3">
			<react:component
				module="{ListTypeDefinitionsAutocomplete} from commerce-product-options-admin-web"
			/>
		</div>
	</aui:form>
	...
	<liferay-frontend:component
		...
		%>'
		module="{CreateOrAssignCPSpecificationOptionListTypeDefinition} from commerce-product-options-admin-web"
	/>
</commerce-ui:modal-content>