...
>
	<frontend-data-set:classic-display
		...
		itemsPerPage="<%= 10 %>"
		propsTransformer="{CPSpecificationOptionListTypeDefinitionPropsTransformer} from commerce-product-options-admin-web"
		style="stacked"
	/>
</commerce-ui:panel>
...
<c:if test="<%= cpSpecificationOption == null %>">
	<liferay-frontend:component
		module="{CPSpecificationOptionDetails} from commerce-product-options-admin-web"
	/>
</c:if>