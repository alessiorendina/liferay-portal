...
<clay:management-toolbar
	...
	propsTransformer="{CPOptionCategoryManagementToolbarPropsTransformer} from commerce-product-options-admin-web"
/>
...
<div id="<portlet:namespace />productOptionCategoriesContainer">
	<div class="closed sidenav-container sidenav-right" id="<portlet:namespace />infoPanelId">
		<c:if test="<%= cpOptionCategoryDisplayContext.isShowInfoPanel() %>">
			<liferay-portlet:resourceURL copyCurrentRenderParameters="<%= false %>" id="/cp_specification_options_admin/cp_option_category_info_panel" var="sidebarPanelURL" />
		...
		<div class="sidenav-content">
			<clay:container-fluid>
				<portlet:actionURL name="/cp_specification_options_admin/edit_cp_option_category" var="editCPOptionCategoryURL" />
						...
						>
							...
							>
								...
								PortletURL rowURL = PortletURLBuilder.createRenderURL(
									...
									"/cp_specification_options_admin/edit_cp_option_category"
								).setRedirect(
									currentURL
								).setParameter(
