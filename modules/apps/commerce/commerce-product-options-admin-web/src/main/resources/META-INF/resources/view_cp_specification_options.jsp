...
<clay:management-toolbar
	...
	propsTransformer="{CPSpecificationOptionManagementToolbarPropsTransformer} from commerce-product-options-admin-web"
/>
...
<div id="<portlet:namespace />productSpecificationOptionsContainer">
	<div class="closed sidenav-container sidenav-right" id="<portlet:namespace />infoPanelId">
		<c:if test="<%= cpSpecificationOptionDisplayContext.isShowInfoPanel() %>">
			<liferay-portlet:resourceURL copyCurrentRenderParameters="<%= false %>" id="/cp_specification_options_admin/cp_specification_option_info_panel" var="sidebarPanelURL" />
		...
		<div class="sidenav-content">
			<clay:container-fluid>
				<portlet:actionURL name="/cp_specification_options_admin/edit_cp_specification_option" var="editCPSpecificationOptionURL" />
						...
						>
							...
							>
								...
								PortletURL rowURL = PortletURLBuilder.createRenderURL(
									...
									"/cp_specification_options_admin/edit_cp_specification_option"
								).setRedirect(
									currentURL
								).setParameter(
