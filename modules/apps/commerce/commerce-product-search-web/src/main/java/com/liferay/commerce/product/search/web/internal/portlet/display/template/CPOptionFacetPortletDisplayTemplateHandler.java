...
package com.liferay.commerce.product.search.web.internal.portlet.display.template;
...
public class CPOptionFacetPortletDisplayTemplateHandler
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"cp-option-facet-display-context",
		...
		TemplateVariableGroup cpOptionsServicesTemplateVariableGroup =
			new TemplateVariableGroup(
				"cp-option-services", getRestrictedVariables(language));
	...
	protected String getTemplatesConfigPath() {
		return "com/liferay/commerce/product/search/web/internal" +
