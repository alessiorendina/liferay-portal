...
>
	<c:if test="<%= cpTaxCategoryDisplayContext.hasManageCPTaxCategoriesPermission() %>">
		<portlet:renderURL var="editURL">
			<portlet:param name="mvcRenderCommandName" value="/cp_tax_category_admin/edit_cp_tax_category" />
		...
		<portlet:actionURL name="/cp_tax_category_admin/edit_cp_tax_category" var="deleteURL">
