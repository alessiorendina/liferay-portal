...
<c:if test="<%= cpTaxCategoryDisplayContext.hasManageCPTaxCategoriesPermission() %>">
	<clay:management-toolbar
		...
		propsTransformer="{CPTaxCategoryManagementToolbarPropsTransformer} from commerce-product-tax-category-admin-web"
	/>

	<div class="container-fluid container-fluid-max-xl">
		<portlet:actionURL name="/cp_tax_category_admin/edit_cp_tax_category" var="editCPTaxCategoryActionURL" />
