...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition_grouped_entry" var="editCPDefinitionGroupedEntryActionURL">
	<portlet:param name="mvcRenderCommandName" value="/cp_definitions_admin/edit_cp_definition_grouped_entry" />
</portlet:actionURL>
