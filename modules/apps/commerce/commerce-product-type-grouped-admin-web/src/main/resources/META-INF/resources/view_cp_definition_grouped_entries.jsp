...
<clay:management-toolbar
	...
	propsTransformer="{CPDefinitionGroupedManagementToolbarPropsTransformer} from commerce-product-type-grouped-admin-web"
/>
...
<div id="<portlet:namespace />cpDefinitionGroupedEntriesContainer">
	<div class="closed sidenav-container sidenav-right" id="<portlet:namespace />infoPanelId">
		<c:if test="<%= cpDefinitionGroupedEntriesDisplayContext.isShowInfoPanel() %>">
			<liferay-portlet:resourceURL copyCurrentRenderParameters="<%= false %>" id="/cp_definitions_admin/cp_definition_grouped_entry_info_panel" var="sidebarPanelURL" />
		...
		<div class="sidenav-content">
			<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition_grouped_entry" var="editCPDefinitionGroupedEntryURL" />
					...
					>
						...
						>
							...
							PortletURL rowURL = PortletURLBuilder.createRenderURL(
								...
								"/cp_definitions_admin/edit_cp_definition_grouped_entry"
							).setParameter(
...
<portlet:actionURL name="/cp_definitions_admin/edit_cp_definition_grouped_entry" var="addDefinitionGroupedEntryURL">
	<portlet:param name="mvcRenderCommandName" value="/cp_definitions_admin/view_cp_definition_grouped_entries" />
</portlet:actionURL>
