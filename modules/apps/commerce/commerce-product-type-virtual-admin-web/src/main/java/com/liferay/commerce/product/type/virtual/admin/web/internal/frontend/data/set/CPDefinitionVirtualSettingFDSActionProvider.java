...
package com.liferay.commerce.product.type.virtual.admin.web.internal.frontend.data.set;

import com.liferay.commerce.product.constants.CPPortletKeys;
import com.liferay.commerce.product.model.CPDefinition;
import com.liferay.commerce.product.type.virtual.admin.web.internal.constants.CPDefinitionVirtualSettingFDSNames;
import com.liferay.commerce.product.type.virtual.admin.web.internal.model.VirtualFile;
...
public class CPDefinitionVirtualSettingFDSActionProvider
	...
	private PortletURL _getVirtualSettingFileDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/cp_definitions_admin/edit_cpd_virtual_setting_file_entry"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
