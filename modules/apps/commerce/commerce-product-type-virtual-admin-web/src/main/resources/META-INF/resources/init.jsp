...
page import="com.liferay.commerce.product.type.virtual.admin.web.internal.constants.CPDefinitionVirtualSettingFDSNames" %><%@
page import="com.liferay.commerce.product.type.virtual.admin.web.internal.display.context.CPDefinitionVirtualSettingDisplayContext" %><%@
page import="com.liferay.commerce.product.type.virtual.admin.web.internal.display.context.CommerceVirtualOrderItemEditDisplayContext" %><%@
page import="com.liferay.commerce.product.type.virtual.admin.web.internal.servlet.taglib.ui.constants.CPDefinitionVirtualSettingFormNavigatorConstants" %><%@
...
String catalogURL = String.valueOf(PortalUtil.getControlPanelPortletURL(request, CPPortletKeys.CP_DEFINITIONS_ADMIN, lifecycle));
%>