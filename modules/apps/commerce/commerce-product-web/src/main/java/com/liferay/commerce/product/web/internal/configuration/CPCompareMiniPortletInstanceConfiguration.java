...
@Meta.OCD(
	id = "com.liferay.commerce.product.web.internal.configuration.CPCompareMiniPortletInstanceConfiguration",
	localization = "content/Language",
	name = "commerce-product-compare-mini-portlet-instance-configuration-name"
)
public interface CPCompareMiniPortletInstanceConfiguration {

	@Meta.AD(
		deflt = CPPortletKeys.CP_COMPARE_MINI,
