...
package com.liferay.commerce.product.web.internal.configuration;
...
@Meta.OCD(
	id = "com.liferay.commerce.product.web.internal.configuration.CPComparePortletInstanceConfiguration",
	localization = "content/Language",
	name = "commerce-product-compare-portlet-instance-configuration-name"
)
public interface CPComparePortletInstanceConfiguration {

	@Meta.AD(
		deflt = CPPortletKeys.CP_COMPARE, name = "cp-content-list-renderer-key",
		required = false
	)
