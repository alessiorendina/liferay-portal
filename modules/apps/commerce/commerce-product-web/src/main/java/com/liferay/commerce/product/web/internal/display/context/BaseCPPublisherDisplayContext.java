...
import com.liferay.commerce.product.web.internal.configuration.CPPublisherPortletInstanceConfiguration;
import com.liferay.commerce.product.web.internal.display.context.helper.CPRequestHelper;
...
public class BaseCPPublisherDisplayContext {
	...
	public List<CPContentListEntryRenderer> getCPContentListEntryRenderers(
		...
		return contentListEntryRendererRegistry.getCPContentListEntryRenderers(
			CPPortletKeys.CP_PUBLISHER, cpType);
	}
	...
	protected final CPRequestHelper _cpRequestHelper;
