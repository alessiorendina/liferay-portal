 ...
 */
public class CPCompareDisplayContext {

	public CPCompareDisplayContext(
		...
		_cpComparePortletInstanceConfiguration =
	...
	public List<CPContentListEntryRenderer> getCPContentListEntryRenderers(
		...
		return _cpContentListEntryRendererRegistry.
			getCPContentListEntryRenderers(CPPortletKeys.CP_COMPARE, cpType);
	}
	...
	public String getDisplayStyle() {
		return _cpComparePortletInstanceConfiguration.displayStyle();
	}
	...
	public int getProductsLimit() {
		return _cpComparePortletInstanceConfiguration.productsLimit();
	}

	public String getSelectionStyle() {
		return _cpComparePortletInstanceConfiguration.selectionStyle();
	}
	...
	private final CPComparePortletInstanceConfiguration
		_cpComparePortletInstanceConfiguration;
