 ...
 */
public class CPCompareMiniDisplayContext {

	public CPCompareMiniDisplayContext(
		...
		_cpCompareMiniPortletInstanceConfiguration =
	...
	public List<CPContentListEntryRenderer> getCPContentListEntryRenderers(
		...
		return _cpContentListEntryRendererRegistry.
			getCPContentListEntryRenderers(
				CPPortletKeys.CP_COMPARE_MINI, cpType);
	}
	...
	public String getDisplayStyle() {
		return _cpCompareMiniPortletInstanceConfiguration.displayStyle();
	}
	...
	public int getProductsLimit() {
		return _cpCompareMiniPortletInstanceConfiguration.productsLimit();
	}

	public String getSelectionStyle() {
		return _cpCompareMiniPortletInstanceConfiguration.selectionStyle();
	}
	...
	private final CPCompareMiniPortletInstanceConfiguration
		_cpCompareMiniPortletInstanceConfiguration;
