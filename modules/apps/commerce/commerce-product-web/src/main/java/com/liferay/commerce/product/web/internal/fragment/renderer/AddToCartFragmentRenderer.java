...
package com.liferay.commerce.product.web.internal.fragment.renderer;
	...
	public String getConfiguration(
		...
		try {
			JSONObject jsonObject = _jsonFactory.createJSONObject(
				StringUtil.read(
					getClass(),
					"/com/liferay/commerce/product/web/internal/fragment" +
						"/renderer/add_to_cart/dependencies" +
							"/configuration.json"));
