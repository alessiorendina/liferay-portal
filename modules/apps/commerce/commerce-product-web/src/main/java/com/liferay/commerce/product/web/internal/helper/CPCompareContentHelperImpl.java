...
package com.liferay.commerce.product.web.internal.helper;
...
import com.liferay.commerce.product.web.internal.configuration.CPCompareMiniPortletInstanceConfiguration;
import com.liferay.commerce.product.web.internal.configuration.CPComparePortletInstanceConfiguration;
...
public class CPCompareContentHelperImpl implements CPCompareContentHelper {
	...
	public String getCompareContentPortletNamespace() {
		return _portal.getPortletNamespace(CPPortletKeys.CP_COMPARE);
	}
	...
	public int getProductsLimit(PortletDisplay portletDisplay)
		...
		if (CPPortletKeys.CP_COMPARE_MINI.equals(
				portletDisplay.getPortletName())) {

			CPCompareMiniPortletInstanceConfiguration
				cpCompareMiniPortletInstanceConfiguration =
					_configurationProvider.getPortletInstanceConfiguration(
						CPCompareMiniPortletInstanceConfiguration.class,
						portletDisplay.getThemeDisplay());

			return cpCompareMiniPortletInstanceConfiguration.productsLimit();
		}
		else if (CPPortletKeys.CP_COMPARE.equals(
					portletDisplay.getPortletName())) {

			CPComparePortletInstanceConfiguration
				cpComparePortletInstanceConfiguration =
					_configurationProvider.getPortletInstanceConfiguration(
						CPComparePortletInstanceConfiguration.class,
						portletDisplay.getThemeDisplay());

			return cpComparePortletInstanceConfiguration.productsLimit();
		}
