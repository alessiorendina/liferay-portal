...
@Component(
	property = {
		...
		"javax.portlet.name=" + CPPortletKeys.CP_COMPARE_MINI,
...
public class CPCompareMiniPortlet extends MVCPortlet {
	...
	public void render(
		...
		try {
			CPCompareMiniDisplayContext cpCompareMiniDisplayContext =
				new CPCompareMiniDisplayContext(
			...
			renderRequest.setAttribute(
				WebKeys.PORTLET_DISPLAY_CONTEXT, cpCompareMiniDisplayContext);
		}
