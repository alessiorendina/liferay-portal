...
@Component(
	property = {
		...
		"javax.portlet.name=" + CPPortletKeys.CP_COMPARE,
...
public class CPComparePortlet extends MVCPortlet {
	...
	public void render(
		...
		try {
			...
			httpServletRequest.setAttribute(
				WebKeys.PORTLET_DISPLAY_CONTEXT, cpCompareDisplayContext);
		}
