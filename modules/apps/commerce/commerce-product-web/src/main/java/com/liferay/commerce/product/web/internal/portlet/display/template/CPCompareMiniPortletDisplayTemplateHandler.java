...
package com.liferay.commerce.product.web.internal.portlet.display.template;

import com.liferay.commerce.product.catalog.CPCatalogEntry;
import com.liferay.commerce.product.constants.CPPortletKeys;
import com.liferay.commerce.product.content.helper.CPContentHelper;
import com.liferay.commerce.product.service.CPDefinitionLocalService;
import com.liferay.commerce.product.web.internal.display.context.CPCompareMiniDisplayContext;
import com.liferay.commerce.product.web.internal.portlet.CPCompareMiniPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CPPortletKeys.CP_COMPARE_MINI,
	service = TemplateHandler.class
)
public class CPCompareMiniPortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CPCompareMiniPortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CPPortletKeys.CP_COMPARE_MINI, resourceBundle));
	...
	public String getResourceName() {
		return CPPortletKeys.CP_COMPARE_MINI;
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"cp-compare-mini-display-context",
			CPCompareMiniDisplayContext.class, "cpCompareMiniDisplayContext");
		templateVariableGroup.addVariable(
