...
import com.liferay.commerce.product.web.internal.display.context.CPCompareDisplayContext;
import com.liferay.commerce.product.web.internal.portlet.CPComparePortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CPPortletKeys.CP_COMPARE,
	service = TemplateHandler.class
)
public class CPComparePortletDisplayTemplateHandler
	extends BasePortletDisplayTemplateHandler {

	@Override
	public String getClassName() {
		return CPComparePortlet.class.getName();
	}
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(CPPortletKeys.CP_COMPARE, resourceBundle));
	...
	public String getResourceName() {
		return CPPortletKeys.CP_COMPARE;
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"cp-compare-display-context", CPCompareDisplayContext.class,
			"cpCompareDisplayContext");
		templateVariableGroup.addVariable(
