...
import com.liferay.commerce.product.web.internal.portlet.CPContentPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CPPortletKeys.CP_CONTENT,
...
public class CPContentPortletDisplayTemplateHandler
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(CPPortletKeys.CP_CONTENT, resourceBundle));
	...
	public String getResourceName() {
		return CPPortletKeys.CP_CONTENT;
	}
