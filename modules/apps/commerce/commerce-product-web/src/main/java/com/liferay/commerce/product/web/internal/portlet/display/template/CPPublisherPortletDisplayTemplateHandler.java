...
import com.liferay.commerce.product.web.internal.display.context.CPPublisherDisplayContext;
import com.liferay.commerce.product.web.internal.portlet.CPPublisherPortlet;
 ...
 */
@Component(
	property = "javax.portlet.name=" + CPPortletKeys.CP_PUBLISHER,
...
public class CPPublisherPortletDisplayTemplateHandler
	...
	public String getName(Locale locale) {
		...
		sb.append(
			_portal.getPortletTitle(
				CPPortletKeys.CP_PUBLISHER, resourceBundle));
	...
	public String getResourceName() {
		return CPPortletKeys.CP_PUBLISHER;
	}
