...
package com.liferay.commerce.product.web.internal.render.list;
...
@Component(
	property = {
		"commerce.product.content.list.renderer.key=" + CPPortletKeys.CP_COMPARE_MINI,
		"commerce.product.content.list.renderer.order=" + Integer.MIN_VALUE,
		"commerce.product.content.list.renderer.portlet.name=" + CPPortletKeys.CP_COMPARE_MINI
	},
