...
<div class="cp-renderer">
	<c:if test="<%= showAddToCartButton %>">
		<liferay-util:dynamic-include key="com.liferay.commerce.product.web#/add_to_cart#pre" />
	</c:if>
	...
	<c:if test="<%= showAddToCartButton %>">
		<liferay-util:dynamic-include key="com.liferay.commerce.product.web#/add_to_cart#post" />
	</c:if>
</div>