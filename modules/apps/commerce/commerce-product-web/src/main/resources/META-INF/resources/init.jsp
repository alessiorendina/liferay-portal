...
page import="com.liferay.commerce.product.web.internal.constants.CPCompareConstants" %><%@
page import="com.liferay.commerce.product.web.internal.constants.CPCompareMiniConstants" %><%@
page import="com.liferay.commerce.product.web.internal.constants.CPContentFDSNames" %><%@
page import="com.liferay.commerce.product.web.internal.constants.CPContentPortletConstants" %><%@
page import="com.liferay.commerce.product.web.internal.constants.CPPublisherConstants" %><%@
page import="com.liferay.commerce.product.web.internal.display.context.CPCompareDisplayContext" %><%@
page import="com.liferay.commerce.product.web.internal.display.context.CPCompareMiniDisplayContext" %><%@
page import="com.liferay.commerce.product.web.internal.display.context.CPContentConfigurationDisplayContext" %><%@
page import="com.liferay.commerce.product.web.internal.display.context.CPPublisherConfigurationDisplayContext" %><%@
page import="com.liferay.commerce.product.web.internal.display.context.CPPublisherDisplayContext" %><%@
page import="com.liferay.commerce.product.web.internal.portlet.CPCompareMiniPortlet" %><%@
page import="com.liferay.commerce.product.web.internal.portlet.CPComparePortlet" %><%@
page import="com.liferay.commerce.product.web.internal.portlet.CPContentPortlet" %><%@
page import="com.liferay.commerce.product.web.internal.portlet.CPPublisherPortlet" %><%@
