...
<div class="mb-5 product-detail" id="<portlet:namespace /><%= cpDefinitionId %>ProductContent">
	<div class="row">
		...
		<div class="col-12 col-md-6">
			...
			<liferay-util:dynamic-include key="com.liferay.commerce.product.type.grouped.admin.web#/grouped_product_type.jsp#" />
			...
			<div class="align-items-end d-flex mt-3 product-detail-actions">
				...
				<liferay-util:dynamic-include key="com.liferay.commerce.product.type.virtual.admin.web#/virtual_product_type.jsp#" />
			</div>
...
<div>
	<react:component
		module="{Tabs} from commerce-product-web"
		props='<%=
	...
	<c:if test="<%= directReplacement %>">
		<div aria-labelledby="navUnderlineReplacementsTab" class="fade <portlet:namespace />tab-element tab-pane tab-pane-collapse tab-pane-replacements" id="<%= navReplacementsId %>" role="tabpanel">
			<frontend-data-set:classic-display
				...
				itemsPerPage="<%= 10 %>"
				propsTransformer="{replacementCPInstancePropsTransformer} from commerce-product-web"
				style="stacked"
			/>
		</div>
	</c:if>
