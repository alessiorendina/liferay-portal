...
public class CommerceOrderTypeRelServiceHttp {
	...
	public static com.liferay.commerce.model.CommerceOrderTypeRel
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceOrderTypeRelServiceUtil.class,
				"getCommerceOrderTypeRel",
				_getCommerceOrderTypeRelParameterTypes3);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceOrderTypeRelServiceUtil.class,
				"getCommerceOrderTypeCommerceChannelRels",
				_getCommerceOrderTypeCommerceChannelRelsParameterTypes4);
	...
	public static int getCommerceOrderTypeCommerceChannelRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceOrderTypeCommerceChannelRelsCountParameterTypes5);
	...
	private static final Class<?>[] _getCommerceOrderTypeRelParameterTypes3 =
		new Class[] {long.class};
	private static final Class<?>[]
		_getCommerceOrderTypeCommerceChannelRelsParameterTypes4 = new Class[] {
