...
package com.liferay.commerce.shipment.admin.web.internal.portlet.action;
...
import com.liferay.commerce.shipment.admin.web.internal.display.context.CommerceShipmentDisplayContext;
import com.liferay.commerce.shipment.admin.web.internal.portlet.action.helper.ActionHelper;
...
@Component(
	property = {
		"javax.portlet.name=" + CommercePortletKeys.COMMERCE_SHIPMENT_ADMIN,
		"mvc.command.name=/commerce_shipment_admin/edit_commerce_shipment_address"
	},
	service = MVCRenderCommand.class
)
public class EditCommerceShipmentAddressMVCRenderCommand
	...
	public String render(
		...
		return "/commerce_shipment/edit_commerce_shipment_address.jsp";
	}
