...
<portlet:actionURL name="/commerce_shipment_admin/edit_commerce_shipment" var="editCommerceShipmentURL" />

<c:if test="<%= commerceShipmentItemId > 0 %>">
	<portlet:actionURL name="/commerce_shipment_admin/edit_commerce_shipment_item" var="editCommerceShipmentURL" />
