...
page import="com.liferay.commerce.shipment.admin.web.internal.constants.CommerceShipmentScreenNavigationConstants" %><%@
page import="com.liferay.commerce.shipment.admin.web.internal.display.context.CommerceShipmentDisplayContext" %><%@
page import="com.liferay.commerce.shipment.admin.web.internal.display.context.CommerceShipmentItemDisplayContext" %><%@
...
String shipmentsURL = String.valueOf(PortalUtil.getControlPanelPortletURL(request, CommercePortletKeys.COMMERCE_SHIPMENT_ADMIN, lifecycle));
