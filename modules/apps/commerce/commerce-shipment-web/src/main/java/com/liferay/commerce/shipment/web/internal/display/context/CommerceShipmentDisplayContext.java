...
import com.liferay.commerce.shipment.web.internal.display.context.helper.CommerceShipmentRequestHelper;
...
public class CommerceShipmentDisplayContext {
	...
	public CommerceShipmentDisplayContext(
		...
		_commerceShipmentRequestHelper = new CommerceShipmentRequestHelper(
			renderRequest);

		ThemeDisplay themeDisplay =
			_commerceShipmentRequestHelper.getThemeDisplay();
	...
	public String getCommerceOrderShippingOptionName(
		...
		return commerceShippingEngine.getCommerceShippingOptionLabel(
			...
			_commerceShipmentRequestHelper.getLocale());
	}
	...
	public SearchContainer<CommerceShipmentItem>
		...
		_commerceShipmentItemSearchContainer = new SearchContainer<>(
			_commerceShipmentRequestHelper.getLiferayPortletRequest(),
	...
	public String getCommerceShipmentStatusLabel(int status) {
		return LanguageUtil.get(
			_commerceShipmentRequestHelper.getRequest(),
			CommerceShipmentConstants.getShipmentStatusLabel(status));
	}

	public PortletURL getPortletURL() {
		LiferayPortletResponse liferayPortletResponse =
			_commerceShipmentRequestHelper.getLiferayPortletResponse();
	...
	public SearchContainer<CommerceShipment> getSearchContainer()
		...
		CommerceChannel commerceChannel =
			_commerceChannelLocalService.fetchCommerceChannelBySiteGroupId(
				_commerceShipmentRequestHelper.getScopeGroupId());
	...
	private final CommerceShipmentRequestHelper _commerceShipmentRequestHelper;
