...
<portlet:actionURL name="/commerce_shipment_admin/edit_commerce_shipment" var="editCommerceShipmentActionURL">
	<portlet:param name="mvcRenderCommandName" value="/commerce_shipment_admin/edit_commerce_shipment" />
</portlet:actionURL>
...
<div class="autofit-float autofit-row shipment-details-header">
	<div class="autofit-col autofit-col-expand">
		<div class="autofit-section">
			...
			<div class="shipment-date shipment-details-subtitle">
				<%= commerceShipmentDisplayContext.getCommerceShipmentShippingDate(commerceShipment) %>
			</div>

			<div class="shipment-time">
				<%= commerceShipmentDisplayContext.getCommerceShipmentShippingTime(commerceShipment) %>
			</div>
		</div>
	</div>
	...
	<div class="autofit-col autofit-col-expand">
		<div class="autofit-section">
			...
			<div class="shipment-details-subtitle shipment-status">
				<%= commerceShipmentDisplayContext.getCommerceShipmentStatusLabel(commerceShipment.getStatus()) %>
			</div>
		</div>
	</div>
	...
	<div class="autofit-col autofit-col-expand">
		<div class="autofit-section">
			...
			<div class="shipment-date shipment-details-subtitle">
				<%= commerceShipmentDisplayContext.getCommerceShipmentExpectedDate(commerceShipment) %>
			</div>

			<div class="shipment-time">
				<%= commerceShipmentDisplayContext.getCommerceShipmentExpectedTime(commerceShipment) %>
			</div>
		</div>
	</div>
</div>
...
<div class="autofit-float autofit-row shipment-details-header">
	...
	<div class="autofit-col autofit-col-expand">
		<div class="autofit-section">
			...
			<%
			String shippingMethodName = commerceShipmentDisplayContext.getCommerceShipmentShippingMethodName(commerceShipment);
			String shippingOptionName = commerceShipmentDisplayContext.getCommerceOrderShippingOptionName(commerceShipment);
			%>
...
<liferay-portlet:actionURL name="/commerce_open_order/edit_commerce_order_item" var="editCommerceOrderItemURL" />

<liferay-ui:search-container
	cssClass="shipment-details-table"
	searchContainer="<%= commerceShipmentDisplayContext.getCommerceShipmentItemsSearchContainer() %>"
>
	...
	>
		...
		>
			...
			<%
			String viewCommerceOrderDetailsURL = commerceShipmentDisplayContext.getViewCommerceOrderDetailsURL(commerceShipmentItem);
			%>
