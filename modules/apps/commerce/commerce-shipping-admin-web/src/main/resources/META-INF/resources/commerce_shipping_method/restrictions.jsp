...
<portlet:actionURL name="/commerce_channels_admin/edit_commerce_shipping_method_address_restriction" var="editCommerceShippingMethodAddressRestrictionActionURL" />
