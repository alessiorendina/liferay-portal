...
import com.liferay.commerce.shipping.engine.fixed.admin.web.internal.display.context.helper.CommerceShippingFixedOptionRequestHelper;
	...
	public List<FDSActionDropdownItem>
		...
		return _getFDSActionTemplates(
			PortletURLBuilder.create(
				...
				"/commerce_order_type_admin/edit_commerce_order_type"
			).setRedirect(
