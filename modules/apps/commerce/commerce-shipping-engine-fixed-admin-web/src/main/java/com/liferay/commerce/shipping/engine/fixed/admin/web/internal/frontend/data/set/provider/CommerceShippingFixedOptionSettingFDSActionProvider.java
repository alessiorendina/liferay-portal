...
package com.liferay.commerce.shipping.engine.fixed.admin.web.internal.frontend.data.set.provider;

import com.liferay.commerce.constants.CommercePortletKeys;
import com.liferay.commerce.model.CommerceShippingMethod;
import com.liferay.commerce.shipping.engine.fixed.admin.web.internal.constants.CommerceShippingFixedOptionFDSNames;
import com.liferay.commerce.shipping.engine.fixed.admin.web.internal.model.ShippingFixedOptionSetting;
...
public class CommerceShippingFixedOptionSettingFDSActionProvider
	...
	private String _getShippingFixedOptionSettingDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_shipping_method_admin/edit_commerce_shipping_fixed_option_rel"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
