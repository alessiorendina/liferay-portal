...
<portlet:actionURL name="/commerce_shipping_method_admin/edit_commerce_shipping_fixed_option_qualifiers" var="editCommerceShippingFixedOptionQualifiersActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{qualifiers} from commerce-shipping-engine-fixed-admin-web"
/>
