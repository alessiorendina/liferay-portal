...
/**
 * Provides the local service interface for AccountEntryShippingOptionRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alessio Antonio Rendina
 * @see AccountEntryShippingOptionRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AccountEntryShippingOptionRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.commerce.shipping.engine.fixed.service.impl.AccountEntryShippingOptionRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the account entry shipping option rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AccountEntryShippingOptionRelLocalServiceUtil} if injection and service tracking are not available.
	 */
