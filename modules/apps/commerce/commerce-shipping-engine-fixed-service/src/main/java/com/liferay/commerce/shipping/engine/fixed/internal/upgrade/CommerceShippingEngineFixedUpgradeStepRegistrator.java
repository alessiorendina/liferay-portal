...
import com.liferay.commerce.shipping.engine.fixed.internal.upgrade.v2_4_0.util.AccountEntryShippingOptionRelTable;
...
public class CommerceShippingEngineFixedUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.3.0", "2.4.0", AccountEntryShippingOptionRelTable.create());
