...
/**
 * Provides the base implementation for the account entry shipping option rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.shipping.engine.fixed.service.impl.AccountEntryShippingOptionRelServiceImpl}.
 * </p>
 *
 * @author Alessio Antonio Rendina
 * @see com.liferay.commerce.shipping.engine.fixed.service.impl.AccountEntryShippingOptionRelServiceImpl
 * @generated
 */
public abstract class AccountEntryShippingOptionRelServiceBaseImpl
	extends BaseServiceImpl
	implements AccountEntryShippingOptionRelService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccountEntryShippingOptionRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AccountEntryShippingOptionRelServiceUtil</code>.
	 */
	...
	/**
	 * Returns the account entry shipping option rel remote service.
	 *
	 * @return the account entry shipping option rel remote service
	 */
	public AccountEntryShippingOptionRelService
		getAccountEntryShippingOptionRelService() {

		return accountEntryShippingOptionRelService;
	}

	/**
	 * Sets the account entry shipping option rel remote service.
	 *
	 * @param accountEntryShippingOptionRelService the account entry shipping option rel remote service
	 */
	public void setAccountEntryShippingOptionRelService(
		AccountEntryShippingOptionRelService
			accountEntryShippingOptionRelService) {

		this.accountEntryShippingOptionRelService =
			accountEntryShippingOptionRelService;
	}
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(accountEntryShippingOptionRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountEntryShippingOptionRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				AccountEntryShippingOptionRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, accountEntryShippingOptionRelService);
		}
	...
	@BeanReference(type = AccountEntryShippingOptionRelService.class)
	protected AccountEntryShippingOptionRelService
		accountEntryShippingOptionRelService;
