...
import com.liferay.commerce.shipping.web.internal.model.ShippingOption;
...
@Component(
	...
	property = {
		"clay.data.provider.key=" + AccountEntryDefaultShippingOptionClayTable.NAME,
		"clay.data.set.display.name=" + AccountEntryDefaultShippingOptionClayTable.NAME
	},
	service = {
...
public class AccountEntryDefaultShippingOptionClayTable
