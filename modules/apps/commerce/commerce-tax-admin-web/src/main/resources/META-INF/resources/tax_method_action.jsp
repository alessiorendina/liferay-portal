...
>
	<c:if test="<%= commerceTaxMethodsDisplayContext.hasUpdateCommerceChannelPermission() %>">
		<portlet:actionURL name="/commerce_channels_admin/edit_commerce_tax_method" var="editURL">
		...
		<portlet:actionURL name="/commerce_tax_method_admin/edit_commerce_tax_method" var="setActiveURL">
