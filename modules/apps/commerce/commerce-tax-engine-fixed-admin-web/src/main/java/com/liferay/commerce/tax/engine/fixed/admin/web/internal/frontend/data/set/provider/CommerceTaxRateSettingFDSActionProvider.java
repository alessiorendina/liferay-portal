...
package com.liferay.commerce.tax.engine.fixed.admin.web.internal.frontend.data.set.provider;
...
import com.liferay.commerce.tax.engine.fixed.admin.web.internal.model.TaxRateSetting;
...
public class CommerceTaxRateSettingFDSActionProvider
	...
	private String _getTaxRateSettingDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_tax_method_admin/edit_commerce_tax_fixed_rate_address_rel"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
