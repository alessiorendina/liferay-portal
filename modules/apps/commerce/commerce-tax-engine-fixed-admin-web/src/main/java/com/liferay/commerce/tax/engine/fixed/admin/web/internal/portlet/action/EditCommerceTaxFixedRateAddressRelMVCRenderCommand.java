...
package com.liferay.commerce.tax.engine.fixed.admin.web.internal.portlet.action;
...
import com.liferay.commerce.tax.engine.fixed.admin.web.internal.display.context.CommerceTaxFixedRateAddressRelsDisplayContext;
...
@Component(
	property = {
		...
		"mvc.command.name=/commerce_tax_method_admin/edit_commerce_tax_fixed_rate_address_rel"
	},
...
public class EditCommerceTaxFixedRateAddressRelMVCRenderCommand
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.tax.engine.fixed.admin.web)"
	)
