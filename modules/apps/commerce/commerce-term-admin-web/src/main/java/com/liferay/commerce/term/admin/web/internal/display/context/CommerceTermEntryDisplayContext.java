...
package com.liferay.commerce.term.admin.web.internal.display.context;

import com.liferay.commerce.frontend.model.HeaderActionModel;
import com.liferay.commerce.term.admin.web.internal.display.context.helper.CommerceTermEntryRequestHelper;
...
public class CommerceTermEntryDisplayContext {
	...
	public String getAddCommerceTermEntryRenderURL() throws Exception {
		return PortletURLBuilder.createRenderURL(
			...
			"/commerce_term_entry_admin/add_commerce_term_entry"
		).setWindowState(
		...
		return ListUtil.fromArray(
			new FDSActionDropdownItem(
				PortletURLBuilder.create(
					...
					"/commerce_term_entry_admin/edit_commerce_term_entry"
				).setRedirect(
	...
	public PortletURL getEditCommerceTermEntryRenderURL() {
		return PortletURLBuilder.create(
			portal.getControlPanelPortletURL(
				commerceTermEntryRequestHelper.getRequest(),
				CommerceTermEntryPortletKeys.COMMERCE_TERM_ENTRY_ADMIN,
