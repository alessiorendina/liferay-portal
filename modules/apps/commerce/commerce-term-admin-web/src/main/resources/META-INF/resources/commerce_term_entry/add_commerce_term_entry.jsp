...
<portlet:actionURL name="/commerce_term_entry_admin/edit_commerce_term_entry" var="editCommerceTermEntryActionURL" />
...
>
	...
	<liferay-frontend:component
		...
		%>'
		module="{addCommerceTermEntry} from commerce-term-admin-web"
	/>
</commerce-ui:modal-content>