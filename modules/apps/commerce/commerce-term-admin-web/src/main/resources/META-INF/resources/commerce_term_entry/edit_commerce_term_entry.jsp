...
<liferay-portlet:renderURL var="editCommerceTermEntryExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_term_entry_admin/edit_commerce_term_entry_external_reference_code" />
...
<liferay-frontend:component
	...
	%>'
	module="{editCommerceTermEntry} from commerce-term-admin-web"
/>