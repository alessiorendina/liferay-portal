...
<portlet:actionURL name="/commerce_term_entry_admin/edit_commerce_term_entry_qualifiers" var="editCommerceTermEntryQualifiersActionURL" />
...
<liferay-frontend:component
	...
	%>'
	module="{qualifiers} from commerce-term-admin-web"
/>