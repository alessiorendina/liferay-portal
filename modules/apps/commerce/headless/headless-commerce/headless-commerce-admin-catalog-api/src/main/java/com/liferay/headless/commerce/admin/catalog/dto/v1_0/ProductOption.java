...
public class ProductOption implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Idempotency key for create and update; addresses the product option on the `by-externalReferenceCode` paths and is unique within the company.",
...
// LIFERAY-REST-BUILDER-HASH:925473818