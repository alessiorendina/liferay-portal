...
public interface ProductOptionValueResource {
	...
	public HttpInvoker.HttpResponse
			getProductOptionByExternalReferenceCodeProductOptionValuesPageHttpResponse(
				String externalReferenceCode, String search,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchProductOptionValueByExternalReferenceCodeHttpResponse(
				String externalReferenceCode,
	...
	public HttpInvoker.HttpResponse
			postProductOptionByExternalReferenceCodeProductOptionValueHttpResponse(
				String externalReferenceCode,
				ProductOptionValue productOptionValue)
		throws Exception;
	...
	public static class ProductOptionValueResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/product-option-values/by-externalReferenceCode/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/productOptions/by-externalReferenceCode/{externalReferenceCode}/productOptionValues");
...
// LIFERAY-REST-BUILDER-HASH:95768971