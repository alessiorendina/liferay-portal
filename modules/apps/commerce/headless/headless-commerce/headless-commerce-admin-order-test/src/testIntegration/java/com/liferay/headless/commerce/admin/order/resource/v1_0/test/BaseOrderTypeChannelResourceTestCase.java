...
public abstract class BaseOrderTypeChannelResourceTestCase {
	...
	@Test
	public void testGetOrderTypeIdOrderTypeChannelsPageWithFilterDateTimeEquals()
		throws Exception {
		...
		for (EntityField entityField : entityFields) {
			Page<OrderTypeChannel> page =
				orderTypeChannelResource.getOrderTypeIdOrderTypeChannelsPage(
					id, null,
					getFilterString(entityField, "between", orderTypeChannel1),
					Pagination.of(1, 2), null);

			assertEquals(
				Collections.singletonList(orderTypeChannel1),
				(List<OrderTypeChannel>)page.getItems());
		}
	}

	@Test
	public void testGetOrderTypeIdOrderTypeChannelsPageWithFilterStringEquals()
		throws Exception {
		...
		for (EntityField entityField : entityFields) {
			Page<OrderTypeChannel> page =
				orderTypeChannelResource.getOrderTypeIdOrderTypeChannelsPage(
					id, null,
					getFilterString(entityField, "eq", orderTypeChannel1),
					Pagination.of(1, 2), null);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BaseOrderTypeChannelResourceTestCase.class);
