...
/**
 * Provides the remote service interface for CPDefinitionDiagramEntry. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Andrea Sbarra
 * @see CPDefinitionDiagramEntryServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CPDefinitionDiagramEntryService extends BaseService {
