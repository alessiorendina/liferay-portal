...
import {CommerceAccountManagementPage} from '../pages/commerce/commerce-account-admin-web/commerceAccountManagementPage';
import {CommerceChannelDefaultsPage} from '../pages/commerce/commerce-account-admin-web/commerceChannelDefaultsPage';
import {CommerceCartPage} from '../pages/commerce/commerce-cart-web/commerceCartPage';
import {CommerceCartSummaryPage} from '../pages/commerce/commerce-cart-web/commerceCartSummaryPage';
import {CommerceAdminChannelDetailsCountriesPage} from '../pages/commerce/commerce-channel-admin-web/commerceAdminChannelDetailsCountriesPage';
import {CommerceAdminChannelDetailsCurrenciesPage} from '../pages/commerce/commerce-channel-admin-web/commerceAdminChannelDetailsCurrenciesPage';
...
import {CommerceAdminCurrenciesPage} from '../pages/commerce/commerce-currency-admin-web/commerceAdminCurrenciesPage';
import {CommerceAdminCurrencyDetailsPage} from '../pages/commerce/commerce-currency-admin-web/commerceAdminCurrencyDetailsPage';
...
import {CommerceAdminOrderDetailsPage} from '../pages/commerce/commerce-order-admin-web/commerceAdminOrderDetailsPage';
import {CommerceAdminOrderNotesPage} from '../pages/commerce/commerce-order-admin-web/commerceAdminOrderNotesPage';
import {CommerceAdminOrdersPage} from '../pages/commerce/commerce-order-admin-web/commerceAdminOrdersPage';
import {CommerceAdminReturnsPage} from '../pages/commerce/commerce-order-admin-web/commerceAdminReturnsPage';
import {OrganizationManagementPage} from '../pages/commerce/commerce-organization-web/organizationManagementPage';
import {CommercePaymentsPage} from '../pages/commerce/commerce-payment-admin-web/commercePaymentsPage';
import {CommerceAdminDiscountDetailsPage} from '../pages/commerce/commerce-pricing-admin-web/commerceAdminDiscountDetailsPage';
import {CommerceAdminDiscountsPage} from '../pages/commerce/commerce-pricing-admin-web/commerceAdminDiscountsPage';
import {SpecificationFacetsPage} from '../pages/commerce/commerce-product-search-web-portlet-instance-configuration-name/specificationFacetsPage';
import {ProductDetailsPage} from '../pages/commerce/commerce-product-web/productDetailsPage';
import {ProductPublisherPage} from '../pages/commerce/commerce-product-web/productPublisherPage';
import {AttachmentsPage} from '../pages/commerce/commerce-product-definitions-admin-web/attachmentsPage';
import {CommerceAdminProductConfigurationEntriesPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductConfigurationEntriesPage';
import {CommerceAdminProductConfigurationEntryPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductConfigurationEntryPage';
import {CommerceAdminProductConfigurationListPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductConfigurationListPage';
import {CommerceAdminProductConfigurationListsPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductConfigurationListsPage';
import {CommerceAdminProductDetailsConfigurationPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsConfigurationPage';
import {CommerceAdminProductDetailsDiagramPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsDiagramPage';
import {CommerceAdminProductDetailsMediaPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsMediaPage';
import {CommerceAdminProductDetailsPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsPage';
import {CommerceAdminProductDetailsProductOptionsPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsProductOptionsPage';
import {CommerceAdminProductDetailsProductRelationsPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsProductRelationsPage';
import {CommerceAdminProductDetailsSkusPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsSkusPage';
import {CommerceAdminProductDetailsVisibilityPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductDetailsVisibilityPage';
import {CommerceAdminProductPage} from '../pages/commerce/commerce-product-definitions-admin-web/commerceAdminProductPage';
import {CommerceSpecificationsPage} from '../pages/commerce/commerce-product-options-admin-web/commerceSpecificationsPage';
import {CommerceAdminShipmentsPage} from '../pages/commerce/commerce-shipment-admin-web/commerceAdminShipmentsPage';
