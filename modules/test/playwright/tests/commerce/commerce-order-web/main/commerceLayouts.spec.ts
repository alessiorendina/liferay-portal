		...
		const layout = await apiHelpers.headlessDelivery.createSitePage({
			pageDefinition: getPageDefinition([
				...
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_product_category_web_internal_portlet_CPCategoryPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
				...
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_address_web_internal_portlet_CommerceAddressPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
				...
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_cart_web_internal_portlet_CommerceCartMiniPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_order_web_internal_portlet_CommerceOpenOrderPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
				...
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_product_web_internal_portlet_CPCompareMiniPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_product_web_internal_portlet_CPComparePortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_product_web_internal_portlet_CPContentPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_product_type_virtual_order_web_internal_portlet_CommerceVirtualOrderItemPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_product_web_internal_portlet_CPPublisherPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
						'com_liferay_commerce_subscription_web_internal_portlet_CommerceSubscriptionPortlet',
				}),
				getWidgetDefinition({
					id: getRandomString(),
					widgetName:
